...
typedef int (*mipos_disk_read_t)( mipos_pdrv_t pdrv, char *buf, mipos_sec_t sec, mipos_sec_t count );
typedef int (*mipos_disk_write_t)( mipos_pdrv_t pdrv, const char *buf, mipos_sec_t sec, mipos_sec_t count);
typedef int (*mipos_disk_ioctl_t)( mipos_pdrv_t pdrv, mipos_ioctl_cmd_t cmd, void *buf);
 ...
 */
int mipos_disk_read( mipos_pdrv_t pdrv, char *buf, mipos_sec_t sector, mipos_sec_t count );
 ...
 * @return  0: Successful, 1: R/W Error, 2: Write Protected, 3: Not Ready, 4 Invalid Parameter
 */
int mipos_disk_write( mipos_pdrv_t pdrv, const char *buf, mipos_sec_t sector, mipos_sec_t count);
