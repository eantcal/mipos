 ...
 * @brief   This file contains all functions prototype and macros for the TIM2
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
#define IS_TIM2_PRESCALER_OK(PRESCALER)                                        \
    (((PRESCALER) == TIM2_PRESCALER_1) || ((PRESCALER) == TIM2_PRESCALER_2) || \
     ((PRESCALER) == TIM2_PRESCALER_4) || ((PRESCALER) == TIM2_PRESCALER_8) || \
...
#define IS_TIM2_OC_MODE_OK(MODE)                                               \
    (((MODE) == TIM2_OCMODE_TIMING) || ((MODE) == TIM2_OCMODE_ACTIVE) ||       \
     ((MODE) == TIM2_OCMODE_INACTIVE) || ((MODE) == TIM2_OCMODE_TOGGLE) ||     \
     ((MODE) == TIM2_OCMODE_PWM1) || ((MODE) == TIM2_OCMODE_PWM2))
...
#define IS_TIM2_IC_PRESCALER_OK(PRESCALER)                                     \
    (((PRESCALER) == TIM2_ICPSC_DIV1) || ((PRESCALER) == TIM2_ICPSC_DIV2) ||   \
     ((PRESCALER) == TIM2_ICPSC_DIV4) || ((PRESCALER) == TIM2_ICPSC_DIV8))
...
#define IS_TIM2_GET_IT_OK(IT)                                                  \
    (((IT) == TIM2_IT_UPDATE) || ((IT) == TIM2_IT_CC1) ||                      \
     ((IT) == TIM2_IT_CC2) || ((IT) == TIM2_IT_CC3))
...
#define IS_TIM2_GET_FLAG_OK(FLAG)                                              \
    (((FLAG) == TIM2_FLAG_UPDATE) || ((FLAG) == TIM2_FLAG_CC1) ||              \
     ((FLAG) == TIM2_FLAG_CC2) || ((FLAG) == TIM2_FLAG_CC3) ||                 \
     ((FLAG) == TIM2_FLAG_CC1OF) || ((FLAG) == TIM2_FLAG_CC2OF) ||             \
