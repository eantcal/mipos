 ...
 * @brief   This file contains all functions prototypes and macros for the UART4
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
typedef enum
{
    UART4_IRDAMODE_NORMAL = (uint8_t)0x00,  /**< 0x00 Irda Normal Mode   */
...
typedef enum
{
    UART4_WAKEUP_IDLELINE = (uint8_t)0x00,   /**< 0x01 Idle Line wake up */
...
typedef enum
{
    UART4_PARITY_NO = (uint8_t)0x00,   /**< No Parity*/
...
typedef enum
{
    UART4_LIN_MODE_MASTER = (uint8_t)0x00, /**<  LIN Master Mode*/
...
typedef enum
{
    UART4_WORDLENGTH_8D = (uint8_t)0x00, /**< 0x00 8 bits Data  */
...
typedef enum
{
    UART4_MODE_RX_ENABLE = (uint8_t)0x08,  /**< 0x08 Receive Enable */
 ...
 * register. UART4_IT_TXE UART4_IT_TC UART4_IT_RXNE UART4_IT_IDLE UART4_IT_OR
 *   - For the UART4_IT_PE value, X means the flag position in the CR1 register.
 *   - For the UART4_IT_LBDF value, X means the flag position in the CR4
 * register.
 *   - For the UART4_IT_LHDF value, X means the flag position in the CR6
 * register. Y: Flag position
 *  - For the following values, Y means the flag (pending bit) position in the
 * SR register. UART4_IT_TXE UART4_IT_TC UART4_IT_RXNE UART4_IT_IDLE UART4_IT_OR
 *     UART4_IT_PE
 *  - For the UART4_IT_LBDF value, Y means the flag position in the CR4
 * register.
 *  - For the UART4_IT_LHDF value, Y means the flag position in the CR6
...
typedef enum
{
    UART4_IT_TXE = (uint16_t)0x0277,  /**< Transmit interrupt */
...
#define IS_UART4_MODE_OK(Mode)                                                 \
    (((Mode) == (uint8_t)UART4_MODE_RX_ENABLE) ||                              \
     ...
     ((Mode) == (uint8_t)((uint8_t)UART4_MODE_TX_ENABLE |                      \
                          (uint8_t)UART4_MODE_RX_ENABLE)) ||                   \
     ((Mode) == (uint8_t)((uint8_t)UART4_MODE_TX_ENABLE |                      \
                          (uint8_t)UART4_MODE_RX_DISABLE)) ||                  \
     ((Mode) == (uint8_t)((uint8_t)UART4_MODE_TX_DISABLE |                     \
                          (uint8_t)UART4_MODE_RX_DISABLE)) ||                  \
     ((Mode) == (uint8_t)((uint8_t)UART4_MODE_TX_DISABLE |                     \
                          (uint8_t)UART4_MODE_RX_ENABLE)))
...
#define IS_UART4_SYNCMODE_OK(SyncMode)                                         \
    (!((((SyncMode) & (((uint8_t)UART4_SYNCMODE_CLOCK_ENABLE) |                \
                       ((uint8_t)UART4_SYNCMODE_CLOCK_DISABLE))) ==            \
        (((uint8_t)UART4_SYNCMODE_CLOCK_ENABLE) |                              \
         ((uint8_t)UART4_SYNCMODE_CLOCK_DISABLE))) ||                          \
       (((SyncMode) & (((uint8_t)UART4_SYNCMODE_CPOL_LOW) |                    \
                       ((uint8_t)UART4_SYNCMODE_CPOL_HIGH))) ==                \
        (((uint8_t)UART4_SYNCMODE_CPOL_LOW) |                                  \
         ((uint8_t)UART4_SYNCMODE_CPOL_HIGH))) ||                              \
       (((SyncMode) & (((uint8_t)UART4_SYNCMODE_CPHA_MIDDLE) |                 \
                       ((uint8_t)UART4_SYNCMODE_CPHA_BEGINING))) ==            \
        (((uint8_t)UART4_SYNCMODE_CPHA_MIDDLE) |                               \
         ((uint8_t)UART4_SYNCMODE_CPHA_BEGINING))) ||                          \
       (((SyncMode) & (((uint8_t)UART4_SYNCMODE_LASTBIT_DISABLE) |             \
                       ((uint8_t)UART4_SYNCMODE_LASTBIT_ENABLE))) ==           \
        (((uint8_t)UART4_SYNCMODE_LASTBIT_DISABLE) |                           \
         ((uint8_t)UART4_SYNCMODE_LASTBIT_ENABLE)))))
...
#define IS_UART4_FLAG_OK(Flag)                                                 \
    (((Flag) == UART4_FLAG_TXE) || ((Flag) == UART4_FLAG_TC) ||                \
     ((Flag) == UART4_FLAG_RXNE) || ((Flag) == UART4_FLAG_IDLE) ||             \
     ((Flag) == UART4_FLAG_OR_LHE) || ((Flag) == UART4_FLAG_NF) ||             \
     ((Flag) == UART4_FLAG_FE) || ((Flag) == UART4_FLAG_PE) ||                 \
     ((Flag) == UART4_FLAG_SBK) || ((Flag) == UART4_FLAG_LSF) ||               \
     ((Flag) == UART4_FLAG_LHDF) || ((Flag) == UART4_FLAG_LBDF))
...
#define IS_UART4_CLEAR_FLAG_OK(Flag)                                           \
    (((Flag) == UART4_FLAG_RXNE) || ((Flag) == UART4_FLAG_LHDF) ||             \
     ((Flag) == UART4_FLAG_LSF) || ((Flag) == UART4_FLAG_LBDF))
...
#define IS_UART4_CONFIG_IT_OK(Interrupt)                                       \
    (((Interrupt) == UART4_IT_PE) || ((Interrupt) == UART4_IT_TXE) ||          \
     ((Interrupt) == UART4_IT_TC) || ((Interrupt) == UART4_IT_RXNE_OR) ||      \
     ((Interrupt) == UART4_IT_IDLE) || ((Interrupt) == UART4_IT_LHDF) ||       \
...
#define IS_UART4_GET_IT_OK(ITPendingBit)                                       \
    (((ITPendingBit) == UART4_IT_TXE) || ((ITPendingBit) == UART4_IT_TC) ||    \
     ((ITPendingBit) == UART4_IT_RXNE) || ((ITPendingBit) == UART4_IT_IDLE) || \
     ((ITPendingBit) == UART4_IT_OR) || ((ITPendingBit) == UART4_IT_LBDF) ||   \
     ((ITPendingBit) == UART4_IT_LHDF) || ((ITPendingBit) == UART4_IT_PE))
...
#define IS_UART4_CLEAR_IT_OK(ITPendingBit)                                     \
    (((ITPendingBit) == UART4_IT_RXNE) || ((ITPendingBit) == UART4_IT_LHDF) || \
...
/**
 * @brief  Macro used by the assert_param function in order to check the
 * different sensitivity values for the UART4_StopBits
 */
#define IS_UART4_STOPBITS_OK(StopBit)                                          \
    (((StopBit) == UART4_STOPBITS_1) || ((StopBit) == UART4_STOPBITS_0_5) ||   \
     ((StopBit) == UART4_STOPBITS_2) || ((StopBit) == UART4_STOPBITS_1_5))
...
#define IS_UART4_PARITY_OK(Parity)                                             \
    (((Parity) == UART4_PARITY_NO) || ((Parity) == UART4_PARITY_EVEN) ||       \
...
#define IS_UART4_SLAVE_OK(Mode)                                                \
    (((Mode) == UART4_LIN_MODE_MASTER) || ((Mode) == UART4_LIN_MODE_SLAVE))
...
void UART4_LINBreakDetectionConfig(
  UART4_LINBreakDetectionLength_TypeDef UART4_LINBreakDetectionLength);
