 ...
 * @brief   This file contains all functions prototype and macros for the ITC
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
#if defined(STM8S903) || defined(STM8AF622x)
    ITC_IRQ_TIM5_OVFTRI =
      (uint8_t)13, /*!< TIM5 update/overflow/underflow/trigger/
                   interrupt */
...
#endif /*STM8S208 or STM8S207 or STM8S007 or STM8S103 or STM8S003 or STM8S903  \
          or STM8AF52Ax or STM8AF62Ax */
...
#endif /*STM8S105 or STM8S005 or STM8S003 or STM8S103 or STM8S903 or           \
...
{
    ITC_PRIORITYLEVEL_0 =
      (uint8_t)0x02, /*!< Software priority level 0 (cannot be written) */
 ...
 * @{
 */
#define CPU_SOFT_INT_DISABLED                                                  \
    ((uint8_t)0x28) /*!< Mask for I1 and I0 bits in CPU_CC register */
...
/* Used by assert function */
#define IS_ITC_INTERRUPTS_DISABLED                                             \
    (ITC_GetSoftIntStatus() == CPU_SOFT_INT_DISABLED)
