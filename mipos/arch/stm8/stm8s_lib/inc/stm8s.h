...
/* Uncomment the line below according to the target STM8S or STM8A device used
   in your application. */
...
/*   Tip: To avoid modifying this file each time you need to switch between
  ...
  - High-Density STM8A devices are the STM8AF52xx STM8AF6269/8x/Ax,
    STM8AF51xx, and STM8AF6169/7x/8x/9x/Ax microcontrollers where the Flash
  memory density ranges between 32 to 128 Kbytes
  - Medium-Density STM8A devices are the STM8AF622x/4x, STM8AF6266/68,
    STM8AF612x/4x, and STM8AF6166/68 microcontrollers where the Flash memory
    density ranges between 8 to 32 Kbytes
  - High-Density STM8S devices are the STM8S207xx, STM8S007 and STM8S208xx
  microcontrollers where the Flash memory density ranges between 32 to 128
  Kbytes.
  - Medium-Density STM8S devices are the STM8S105x and STM8S005 microcontrollers
    where the Flash memory density ranges between 16 to 32-Kbytes.
  - Low-Density STM8A devices are the STM8AF622x microcontrollers where the
  Flash density is 8 Kbytes.
  - Low-Density STM8S devices are the STM8S103xx, STM8S003 and STM8S903xx
  microcontrollers where the Flash density is 8 Kbytes. */
...
/**
  ...
  */
  ...
  defined(STM8AF52Ax) || defined(STM8AF62Ax) || defined(STM8AF622x)
#define HSE_VALUE                                                              \
...
/* For FLASH routines, select whether pointer will be declared as near (2 bytes,
  ...
  defined(STM8S003) || defined(STM8S903) || defined(STM8AF626x) ||             \
  defined(STM8AF622x)
...
#endif /* STM8S105 or STM8S103 or STM8S003 or STM8S903 or STM8AF626x or        \
          STM8AF622x */
...
#define __STM8S_STDPERIPH_VERSION_MAIN                                         \
    ((uint8_t)0x02) /*!< [31:24] main version */
#define __STM8S_STDPERIPH_VERSION_SUB1                                         \
    ((uint8_t)0x02) /*!< [23:16] sub1 version */
#define __STM8S_STDPERIPH_VERSION_SUB2                                         \
    ((uint8_t)0x00) /*!< [15:8]  sub2 version */
#define __STM8S_STDPERIPH_VERSION_RC                                           \
    ((uint8_t)0x00) /*!< [7:0]  release candidate */
#define __STM8S_STDPERIPH_VERSION                                              \
    ((__STM8S_STDPERIPH_VERSION_MAIN << 24) |                                  \
     (__STM8S_STDPERIPH_VERSION_SUB1 << 16) |                                  \
     (__STM8S_STDPERIPH_VERSION_SUB2 << 8) | (__STM8S_STDPERIPH_VERSION_RC))
...
#define IS_FUNCTIONALSTATE_OK(STATE)                                           \
...
#define ADC1_CSR_AWDIE                                                         \
    ((uint8_t)0x10) /*!< Analog Watchdog interrupt enable mask */
...
#endif /* (STM8S105) ||(STM8S103) || (STM8S005) ||(STM8S003) || (STM8S903) ||  \
          (STM8AF626x) || (STM8AF622x) */
/**
 * @}
 */
...
#endif /* (STM8S208) ||(STM8S207) || defined (STM8S007) || (STM8AF62Ax) ||     \
          (STM8AF52Ax) */
/**
 * @}
 */
...
#define AWU_APR_APR                                                            \
    ((uint8_t)0x3F) /*!< Asynchronous Prescaler divider mask                   \
                     */
 ...
 * @{
 */
#define BEEP_CSR_BEEPSEL                                                       \
    ((uint8_t)0xC0)                      /*!< Beeper frequency selection mask  \
                                          */
 ...
 * @{
 */
#define CLK_ICKR_SWUAH                                                         \
    ((uint8_t)0x20) /*!< Slow Wake-up from Active Halt/Halt modes */
#define CLK_ICKR_LSIRDY                                                        \
    ((uint8_t)0x10) /*!< Low speed internal oscillator ready */
#define CLK_ICKR_LSIEN                                                         \
    ((uint8_t)0x08) /*!< Low speed internal RC oscillator enable */
#define CLK_ICKR_FHWU                                                          \
    ((uint8_t)0x04) /*!< Fast Wake-up from Active Halt/Halt mode */
#define CLK_ICKR_HSIRDY                                                        \
    ((uint8_t)0x02) /*!< High speed internal RC oscillator ready */
#define CLK_ICKR_HSIEN                                                         \
    ((uint8_t)0x01) /*!< High speed internal RC oscillator enable */

#define CLK_ECKR_HSERDY                                                        \
    ((uint8_t)0x02) /*!< High speed external crystal oscillator ready */
#define CLK_ECKR_HSEEN                                                         \
    ((uint8_t)0x01) /*!< High speed external crystal oscillator enable */
...
#define CLK_CSSR_CSSDIE                                                        \
    ((uint8_t)0x04) /*!< Clock security system detection interrupt enable */
#define CLK_CSSR_AUX                                                           \
    ((uint8_t)0x02) /*!< Auxiliary oscillator connected to master clock */
...
#define CLK_CCOR_CCORDY                                                        \
    ((uint8_t)0x20) /*!< Configurable clock output ready                       \
                     */
#define CLK_CCOR_CCOSEL                                                        \
    ((uint8_t)0x1E) /*!< Configurable clock output selection */
#define CLK_CCOR_CCOEN                                                         \
    ((uint8_t)0x01) /*!< Configurable clock output enable                      \
                     */

#define CLK_HSITRIMR_HSITRIM                                                   \
    ((uint8_t)0x07) /*!< High speed internal oscillator trimmer */
...
#define TIM1_CR1_CMS                                                           \
    ((uint8_t)0x60)                   /*!< Center-aligned Mode Selection mask. \
                                       */
...
#define TIM1_CR2_COMS                                                          \
    ((uint8_t)0x04) /*!< Capture/Compare Control Update Selection mask. */
#define TIM1_CR2_CCPC                                                          \
    ((uint8_t)0x01) /*!< Capture/Compare Preloaded Control mask. */
/* SMCR*/
...
#define TIM1_IER_COMIE                                                         \
    ((uint8_t)0x20) /*!<  Commutation Interrupt Enable mask.*/
#define TIM1_IER_CC4IE                                                         \
    ((uint8_t)0x10) /*!< Capture/Compare 4 Interrupt Enable mask. */
#define TIM1_IER_CC3IE                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Interrupt Enable mask. */
#define TIM1_IER_CC2IE                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Enable mask. */
#define TIM1_IER_CC1IE                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Enable mask. */
...
#define TIM1_SR1_COMIF                                                         \
    ((uint8_t)0x20) /*!< Commutation Interrupt Flag mask.                      \
                     */
#define TIM1_SR1_CC4IF                                                         \
    ((uint8_t)0x10) /*!< Capture/Compare 4 Interrupt Flag mask. */
#define TIM1_SR1_CC3IF                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Interrupt Flag mask. */
#define TIM1_SR1_CC2IF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Flag mask. */
#define TIM1_SR1_CC1IF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Flag mask. */
#define TIM1_SR1_UIF ((uint8_t)0x01) /*!< Update Interrupt Flag mask. */
/*SR2*/
#define TIM1_SR2_CC4OF                                                         \
    ((uint8_t)0x10) /*!< Capture/Compare 4 Overcapture Flag mask. */
#define TIM1_SR2_CC3OF                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Overcapture Flag mask. */
#define TIM1_SR2_CC2OF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Overcapture Flag mask. */
#define TIM1_SR2_CC1OF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Overcapture Flag mask. */
/*EGR*/
#define TIM1_EGR_BG ((uint8_t)0x80) /*!< Break Generation mask. */
#define TIM1_EGR_TG ((uint8_t)0x40) /*!< Trigger Generation mask. */
#define TIM1_EGR_COMG                                                          \
    ((uint8_t)0x20) /*!< Capture/Compare Control Update Generation mask. */
#define TIM1_EGR_CC4G                                                          \
    ((uint8_t)0x10) /*!< Capture/Compare 4 Generation mask.                    \
                     */
#define TIM1_EGR_CC3G                                                          \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Generation mask.                    \
                     */
#define TIM1_EGR_CC2G                                                          \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Generation mask.                    \
                     */
#define TIM1_EGR_CC1G                                                          \
    ((uint8_t)0x02)                 /*!< Capture/Compare 1 Generation mask.    \
                                     */
#define TIM1_EGR_UG ((uint8_t)0x01) /*!< Update Generation mask. */
/*CCMR*/
#define TIM1_CCMR_ICxPSC                                                       \
    ((uint8_t)0x0C)                    /*!< Input Capture x Prescaler mask.    \
                                        */
...
#define TIM1_CCMR_OCxPE                                                        \
    ((uint8_t)0x08) /*!< Output Compare x Preload Enable mask. */
#define TIM1_CCMR_OCxFE                                                        \
    ((uint8_t)0x04) /*!< Output Compare x Fast Enable mask. */
#define TIM1_CCMR_CCxS                                                         \
    ((uint8_t)0x03) /*!< Capture/Compare x Selection mask.                     \
                     */

#define CCMR_TIxDirect_Set ((uint8_t)0x01)
/*CCER1*/
#define TIM1_CCER1_CC2NP                                                       \
    ((uint8_t)0x80) /*!< Capture/Compare 2 Complementary output Polarity mask. \
                     */
#define TIM1_CCER1_CC2NE                                                       \
    ((uint8_t)0x40) /*!< Capture/Compare 2 Complementary output enable mask.   \
                     */
#define TIM1_CCER1_CC2P                                                        \
    ((uint8_t)0x20) /*!< Capture/Compare 2 output Polarity mask. */
#define TIM1_CCER1_CC2E                                                        \
    ((uint8_t)0x10) /*!< Capture/Compare 2 output enable mask. */
#define TIM1_CCER1_CC1NP                                                       \
    ((uint8_t)0x08) /*!< Capture/Compare 1 Complementary output Polarity mask. \
                     */
#define TIM1_CCER1_CC1NE                                                       \
    ((uint8_t)0x04) /*!< Capture/Compare 1 Complementary output enable mask.   \
                     */
#define TIM1_CCER1_CC1P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 1 output Polarity mask. */
#define TIM1_CCER1_CC1E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 1 output enable mask. */
/*CCER2*/
#define TIM1_CCER2_CC4P                                                        \
    ((uint8_t)0x20) /*!< Capture/Compare 4 output Polarity mask. */
#define TIM1_CCER2_CC4E                                                        \
    ((uint8_t)0x10) /*!< Capture/Compare 4 output enable mask. */
#define TIM1_CCER2_CC3NP                                                       \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Complementary output Polarity mask. \
                     */
#define TIM1_CCER2_CC3NE                                                       \
    ((uint8_t)0x04) /*!< Capture/Compare 3 Complementary output enable mask.   \
                     */
#define TIM1_CCER2_CC3P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 3 output Polarity mask. */
#define TIM1_CCER2_CC3E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 3 output enable mask. */
/*CNTRH*/
...
/*CCR1*/
#define TIM1_CCR1H_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (MSB) mask. */
#define TIM1_CCR1L_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (LSB) mask. */
/*CCR2*/
#define TIM1_CCR2H_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (MSB) mask. */
#define TIM1_CCR2L_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (LSB) mask. */
/*CCR3*/
#define TIM1_CCR3H_CCR3                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 3 Value (MSB) mask. */
#define TIM1_CCR3L_CCR3                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 3 Value (LSB) mask. */
/*CCR4*/
#define TIM1_CCR4H_CCR4                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 4 Value (MSB) mask. */
#define TIM1_CCR4L_CCR4                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 4 Value (LSB) mask. */
/*BKR*/
...
#define TIM1_BKR_OSSR                                                          \
    ((uint8_t)0x08) /*!< Off-State Selection for Run mode mask. */
#define TIM1_BKR_OSSI                                                          \
    ((uint8_t)0x04) /*!< Off-State Selection for Idle mode mask. */
...
/*OISR*/
#define TIM1_OISR_OIS4                                                         \
    ((uint8_t)0x40) /*!< Output Idle state 4 (OC4 output) mask. */
#define TIM1_OISR_OIS3N                                                        \
    ((uint8_t)0x20) /*!< Output Idle state 3 (OC3N output) mask. */
#define TIM1_OISR_OIS3                                                         \
    ((uint8_t)0x10) /*!< Output Idle state 3 (OC3 output) mask. */
#define TIM1_OISR_OIS2N                                                        \
    ((uint8_t)0x08) /*!< Output Idle state 2 (OC2N output) mask. */
#define TIM1_OISR_OIS2                                                         \
    ((uint8_t)0x04) /*!< Output Idle state 2 (OC2 output) mask. */
#define TIM1_OISR_OIS1N                                                        \
    ((uint8_t)0x02) /*!< Output Idle state 1 (OC1N output) mask. */
#define TIM1_OISR_OIS1                                                         \
    ((uint8_t)0x01) /*!< Output Idle state 1 (OC1 output) mask. */
/**
 * @}
 */
...
/*IER*/
#define TIM2_IER_CC3IE                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Interrupt Enable mask. */
#define TIM2_IER_CC2IE                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Enable mask. */
#define TIM2_IER_CC1IE                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Enable mask. */
#define TIM2_IER_UIE ((uint8_t)0x01) /*!< Update Interrupt Enable mask. */
/*SR1*/
#define TIM2_SR1_CC3IF                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Interrupt Flag mask. */
#define TIM2_SR1_CC2IF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Flag mask. */
#define TIM2_SR1_CC1IF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Flag mask. */
#define TIM2_SR1_UIF ((uint8_t)0x01) /*!< Update Interrupt Flag mask. */
/*SR2*/
#define TIM2_SR2_CC3OF                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Overcapture Flag mask. */
#define TIM2_SR2_CC2OF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Overcapture Flag mask. */
#define TIM2_SR2_CC1OF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Overcapture Flag mask. */
/*EGR*/
#define TIM2_EGR_CC3G                                                          \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Generation mask.                    \
                     */
#define TIM2_EGR_CC2G                                                          \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Generation mask.                    \
                     */
#define TIM2_EGR_CC1G                                                          \
    ((uint8_t)0x02)                 /*!< Capture/Compare 1 Generation mask.    \
                                     */
#define TIM2_EGR_UG ((uint8_t)0x01) /*!< Update Generation mask. */
/*CCMR*/
#define TIM2_CCMR_ICxPSC                                                       \
    ((uint8_t)0x0C)                    /*!< Input Capture x Prescaler mask.    \
                                        */
...
#define TIM2_CCMR_OCxPE                                                        \
    ((uint8_t)0x08) /*!< Output Compare x Preload Enable mask. */
#define TIM2_CCMR_CCxS                                                         \
    ((uint8_t)0x03) /*!< Capture/Compare x Selection mask.                     \
                     */
/*CCER1*/
#define TIM2_CCER1_CC2P                                                        \
    ((uint8_t)0x20) /*!< Capture/Compare 2 output Polarity mask. */
#define TIM2_CCER1_CC2E                                                        \
    ((uint8_t)0x10) /*!< Capture/Compare 2 output enable mask. */
#define TIM2_CCER1_CC1P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 1 output Polarity mask. */
#define TIM2_CCER1_CC1E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 1 output enable mask. */
/*CCER2*/
#define TIM2_CCER2_CC3P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 3 output Polarity mask. */
#define TIM2_CCER2_CC3E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 3 output enable mask. */
/*CNTR*/
...
/*CCR1*/
#define TIM2_CCR1H_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (MSB) mask. */
#define TIM2_CCR1L_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (LSB) mask. */
/*CCR2*/
#define TIM2_CCR2H_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (MSB) mask. */
#define TIM2_CCR2L_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (LSB) mask. */
/*CCR3*/
#define TIM2_CCR3H_CCR3                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 3 Value (MSB) mask. */
#define TIM2_CCR3L_CCR3                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 3 Value (LSB) mask. */
...
/*IER*/
#define TIM3_IER_CC2IE                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Enable mask. */
#define TIM3_IER_CC1IE                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Enable mask. */
#define TIM3_IER_UIE ((uint8_t)0x01) /*!< Update Interrupt Enable mask. */
/*SR1*/
#define TIM3_SR1_CC2IF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Flag mask. */
#define TIM3_SR1_CC1IF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Flag mask. */
#define TIM3_SR1_UIF ((uint8_t)0x01) /*!< Update Interrupt Flag mask. */
/*SR2*/
#define TIM3_SR2_CC2OF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Overcapture Flag mask. */
#define TIM3_SR2_CC1OF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Overcapture Flag mask. */
/*EGR*/
#define TIM3_EGR_CC2G                                                          \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Generation mask.                    \
                     */
#define TIM3_EGR_CC1G                                                          \
    ((uint8_t)0x02)                 /*!< Capture/Compare 1 Generation mask.    \
                                     */
#define TIM3_EGR_UG ((uint8_t)0x01) /*!< Update Generation mask. */
/*CCMR*/
#define TIM3_CCMR_ICxPSC                                                       \
    ((uint8_t)0x0C)                    /*!< Input Capture x Prescaler mask.    \
                                        */
...
#define TIM3_CCMR_OCxPE                                                        \
    ((uint8_t)0x08) /*!< Output Compare x Preload Enable mask. */
#define TIM3_CCMR_CCxS                                                         \
    ((uint8_t)0x03) /*!< Capture/Compare x Selection mask.                     \
                     */
/*CCER1*/
#define TIM3_CCER1_CC2P                                                        \
    ((uint8_t)0x20) /*!< Capture/Compare 2 output Polarity mask. */
#define TIM3_CCER1_CC2E                                                        \
    ((uint8_t)0x10) /*!< Capture/Compare 2 output enable mask. */
#define TIM3_CCER1_CC1P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 1 output Polarity mask. */
#define TIM3_CCER1_CC1E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 1 output enable mask. */
/*CNTR*/
...
/*CCR1*/
#define TIM3_CCR1H_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (MSB) mask. */
#define TIM3_CCR1L_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (LSB) mask. */
/*CCR2*/
#define TIM3_CCR2H_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (MSB) mask. */
#define TIM3_CCR2L_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (LSB) mask. */
/**
 * @}
 */
...
#define TIM5_IER_CC3IE                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Interrupt Enable mask. */
#define TIM5_IER_CC2IE                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Enable mask. */
#define TIM5_IER_CC1IE                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Enable mask. */
...
#define TIM5_SR1_CC3IF                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Interrupt Flag mask. */
#define TIM5_SR1_CC2IF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Interrupt Flag mask. */
#define TIM5_SR1_CC1IF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Interrupt Flag mask. */
#define TIM5_SR1_UIF ((uint8_t)0x01) /*!< Update Interrupt Flag mask. */
/*SR2*/
#define TIM5_SR2_CC3OF                                                         \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Overcapture Flag mask. */
#define TIM5_SR2_CC2OF                                                         \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Overcapture Flag mask. */
#define TIM5_SR2_CC1OF                                                         \
    ((uint8_t)0x02) /*!< Capture/Compare 1 Overcapture Flag mask. */
/*EGR*/
#define TIM5_EGR_TG ((uint8_t)0x40) /*!< Trigger Generation mask. */
#define TIM5_EGR_CC3G                                                          \
    ((uint8_t)0x08) /*!< Capture/Compare 3 Generation mask.                    \
                     */
#define TIM5_EGR_CC2G                                                          \
    ((uint8_t)0x04) /*!< Capture/Compare 2 Generation mask.                    \
                     */
#define TIM5_EGR_CC1G                                                          \
    ((uint8_t)0x02)                 /*!< Capture/Compare 1 Generation mask.    \
                                     */
#define TIM5_EGR_UG ((uint8_t)0x01) /*!< Update Generation mask. */
/*CCMR*/
#define TIM5_CCMR_ICxPSC                                                       \
    ((uint8_t)0x0C)                    /*!< Input Capture x Prescaler mask.    \
                                        */
...
#define TIM5_CCMR_OCxPE                                                        \
    ((uint8_t)0x08) /*!< Output Compare x Preload Enable mask. */
#define TIM5_CCMR_CCxS                                                         \
    ((uint8_t)0x03) /*!< Capture/Compare x Selection mask.                     \
                     */
/*CCER1*/
#define TIM5_CCER1_CC2P                                                        \
    ((uint8_t)0x20) /*!< Capture/Compare 2 output Polarity mask. */
#define TIM5_CCER1_CC2E                                                        \
    ((uint8_t)0x10) /*!< Capture/Compare 2 output enable mask. */
#define TIM5_CCER1_CC1P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 1 output Polarity mask. */
#define TIM5_CCER1_CC1E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 1 output enable mask. */
/*CCER2*/
#define TIM5_CCER2_CC3P                                                        \
    ((uint8_t)0x02) /*!< Capture/Compare 3 output Polarity mask. */
#define TIM5_CCER2_CC3E                                                        \
    ((uint8_t)0x01) /*!< Capture/Compare 3 output enable mask. */
/*CNTR*/
...
/*CCR1*/
#define TIM5_CCR1H_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (MSB) mask. */
#define TIM5_CCR1L_CCR1                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 1 Value (LSB) mask. */
/*CCR2*/
#define TIM5_CCR2H_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (MSB) mask. */
#define TIM5_CCR2L_CCR2                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 2 Value (LSB) mask. */
/*CCR3*/
#define TIM5_CCR3H_CCR3                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 3 Value (MSB) mask. */
#define TIM5_CCR3L_CCR3                                                        \
    ((uint8_t)0xFF) /*!< Capture/Compare 3 Value (LSB) mask. */
/*CCMR*/
...
#define I2C_CR1_NOSTRETCH                                                      \
    ((uint8_t)0x80) /*!< Clock Stretching Disable (Slave mode) */
...
#define I2C_SR1_RXNE                                                           \
    ((uint8_t)0x40)                   /*!< Data Register not Empty (receivers) \
                                       */
...
#define I2C_SR1_ADDR                                                           \
    ((uint8_t)0x02) /*!< Address sent (master mode)/matched (slave mode) */
...
#define I2C_SR3_GENCALL                                                        \
    ((uint8_t)0x10)                  /*!< General Call Header (Slave mode)     \
                                      */
...
#define I2C_CCRL_CCR                                                           \
    ((uint8_t)0xFF) /*!< Clock Control Register (Master mode) */

#define I2C_CCRH_FS ((uint8_t)0x80)   /*!< Master Mode Selection */
#define I2C_CCRH_DUTY ((uint8_t)0x40) /*!< Fast Mode Duty Cycle */
#define I2C_CCRH_CCR                                                           \
    ((uint8_t)0x0F) /*!< Clock Control Register in Fast/Standard mode (Master  \
                       mode) bits [11..8] */

#define I2C_TRISER_TRISE                                                       \
...
#define ITC_SPRX_RESET_VALUE                                                   \
    ((uint8_t)0xFF) /*!< Reset value of Software Priority registers */
...
#define CPU_CC_I1I0                                                            \
    ((uint8_t)0x28) /*!< Condition Code register, I1 and I0 bits mask */
...
{
    __IO uint8_t
      CR1; /*!< External Interrupt Control Register for PORTA to PORTD */
    __IO uint8_t
      CR2; /*!< External Interrupt Control Register for PORTE and TLI */
} EXTI_TypeDef;
...
#define EXTI_CR1_PDIS                                                          \
    ((uint8_t)0xC0) /*!< PORTD external interrupt sensitivity bits mask */
#define EXTI_CR1_PCIS                                                          \
    ((uint8_t)0x30) /*!< PORTC external interrupt sensitivity bits mask */
#define EXTI_CR1_PBIS                                                          \
    ((uint8_t)0x0C) /*!< PORTB external interrupt sensitivity bits mask */
#define EXTI_CR1_PAIS                                                          \
    ((uint8_t)0x03) /*!< PORTA external interrupt sensitivity bits mask */

#define EXTI_CR2_TLIS                                                          \
    ((uint8_t)0x04) /*!< Top level interrupt sensitivity bit mask */
#define EXTI_CR2_PEIS                                                          \
    ((uint8_t)0x03) /*!< PORTE external interrupt sensitivity bits mask */
...
#define FLASH_CR1_AHALT                                                        \
    ((uint8_t)0x04)                   /*!< Standby in Active Halt mode mask    \
                                       */
...
#define FLASH_IAPSR_HVOFF                                                      \
    ((uint8_t)0x40)                     /*!< End of high voltage flag mask     \
                                         */
...
#define FLASH_IAPSR_PUL                                                        \
    ((uint8_t)0x02) /*!< Flash Program memory unlocked flag mask */
#define FLASH_IAPSR_WR_PG_DIS                                                  \
    ((uint8_t)0x01) /*!< Write attempted to protected page mask */

#define FLASH_PUKR_PUK                                                         \
    ((uint8_t)0xFF) /*!< Flash Program memory unprotection mask */
...
{
    __IO uint8_t OPT0;  /*!< Option byte 0: Read-out protection (not accessible
                           in IAP mode) */
...
#define RST_SR_ILLOPF                                                          \
    ((uint8_t)0x04)                  /*!< Illegal opcode reset flag bit mask   \
                                      */
...
#define SPI_CR1_RESET_VALUE                                                    \
    ((uint8_t)0x00) /*!< Control Register 1 reset value */
#define SPI_CR2_RESET_VALUE                                                    \
    ((uint8_t)0x00) /*!< Control Register 2 reset value */
#define SPI_ICR_RESET_VALUE                                                    \
    ((uint8_t)0x00) /*!< Interrupt Control Register reset value */
...
#define SPI_CRCPR_RESET_VALUE                                                  \
    ((uint8_t)0x07) /*!< Polynomial Register reset value */
#define SPI_RXCRCR_RESET_VALUE                                                 \
    ((uint8_t)0x00) /*!< RX CRC Register reset value */
#define SPI_TXCRCR_RESET_VALUE                                                 \
    ((uint8_t)0x00) /*!< TX CRC Register reset value */
...
#define SPI_CR2_BDM                                                            \
    ((uint8_t)0x80) /*!< Bi-directional data mode enable mask                  \
                     */
#define SPI_CR2_BDOE                                                           \
    ((uint8_t)0x40) /*!< Output enable in bi-directional mode mask */
#define SPI_CR2_CRCEN                                                          \
    ((uint8_t)0x20) /*!< Hardware CRC calculation enable mask */
...
#define SPI_ICR_TXEI                                                           \
    ((uint8_t)0x80) /*!< Tx buffer empty interrupt enable mask */
#define SPI_ICR_RXEI                                                           \
    ((uint8_t)0x40) /*!< Rx buffer empty interrupt enable mask */
...
#define UART1_SR_RXNE                                                          \
    ((uint8_t)0x20)                   /*!< Read Data Register Not Empty mask   \
                                       */
...
#define UART1_BRR1_DIVM                                                        \
    ((uint8_t)0xFF) /*!< LSB mantissa of UART1DIV [7:0] mask */

#define UART1_BRR2_DIVM                                                        \
    ((uint8_t)0xF0) /*!< MSB mantissa of UART1DIV [11:8] mask */
#define UART1_BRR2_DIVF                                                        \
    ((uint8_t)0x0F) /*!< Fraction bits of UART1DIV [3:0] mask */

#define UART1_CR1_R8 ((uint8_t)0x80) /*!< Receive Data bit 8 */
#define UART1_CR1_T8 ((uint8_t)0x40) /*!< Transmit data bit 8 */
#define UART1_CR1_UARTD                                                        \
    ((uint8_t)0x20) /*!< UART1 Disable (for low power consumption) */
...
#define UART1_CR1_PIEN                                                         \
    ((uint8_t)0x01) /*!< UART1 Parity Interrupt Enable mask */

#define UART1_CR2_TIEN                                                         \
    ((uint8_t)0x80) /*!< Transmitter Interrupt Enable mask                     \
                     */
#define UART1_CR2_TCIEN                                                        \
    ((uint8_t)0x40) /*!< Transmission Complete Interrupt Enable mask */
#define UART1_CR2_RIEN ((uint8_t)0x20) /*!< Receiver Interrupt Enable mask */
#define UART1_CR2_ILIEN                                                        \
    ((uint8_t)0x10)                   /*!< IDLE Line Interrupt Enable mask     \
                                       */
...
#define UART1_CR4_LBDIEN                                                       \
    ((uint8_t)0x40) /*!< LIN Break Detection Interrupt Enable mask */
...
#define UART2_BRR1_DIVM                                                        \
    ((uint8_t)0xFF) /*!< LSB mantissa of UART2DIV [7:0] mask */

#define UART2_BRR2_DIVM                                                        \
    ((uint8_t)0xF0) /*!< MSB mantissa of UART2DIV [11:8] mask */
#define UART2_BRR2_DIVF                                                        \
    ((uint8_t)0x0F) /*!< Fraction bits of UART2DIV [3:0] mask */

#define UART2_CR1_R8 ((uint8_t)0x80) /*!< Receive Data bit 8 */
#define UART2_CR1_T8 ((uint8_t)0x40) /*!< Transmit data bit 8 */
#define UART2_CR1_UARTD                                                        \
    ((uint8_t)0x20) /*!< UART2 Disable (for low power consumption) */
...
#define UART2_CR1_PIEN                                                         \
    ((uint8_t)0x01) /*!< UART2 Parity Interrupt Enable mask */

#define UART2_CR2_TIEN                                                         \
    ((uint8_t)0x80) /*!< Transmitter Interrupt Enable mask                     \
                     */
#define UART2_CR2_TCIEN                                                        \
    ((uint8_t)0x40) /*!< Transmission Complete Interrupt Enable mask */
#define UART2_CR2_RIEN ((uint8_t)0x20) /*!< Receiver Interrupt Enable mask */
#define UART2_CR2_ILIEN                                                        \
    ((uint8_t)0x10)                   /*!< IDLE Line Interrupt Enable mask     \
                                       */
...
#define UART2_CR6_LHDIEN                                                       \
    ((uint8_t)0x04) /*!< LIN Header Detection Interrupt Enable */
...
#define UART3_BRR1_DIVM                                                        \
    ((uint8_t)0xFF) /*!< LSB mantissa of UARTDIV [7:0] mask */

#define UART3_BRR2_DIVM                                                        \
    ((uint8_t)0xF0) /*!< MSB mantissa of UARTDIV [11:8] mask */
#define UART3_BRR2_DIVF                                                        \
    ((uint8_t)0x0F) /*!< Fraction bits of UARTDIV [3:0] mask */

#define UART3_CR1_R8 ((uint8_t)0x80) /*!< Receive Data bit 8 */
#define UART3_CR1_T8 ((uint8_t)0x40) /*!< Transmit data bit 8 */
#define UART3_CR1_UARTD                                                        \
    ((uint8_t)0x20) /*!< UART Disable (for low power consumption) */
...
#define UART3_CR1_PIEN                                                         \
    ((uint8_t)0x01) /*!< Parity interrupt enable bit mask                      \
                     */

#define UART3_CR2_TIEN                                                         \
    ((uint8_t)0x80) /*!< Transmitter Interrupt Enable mask                     \
                     */
#define UART3_CR2_TCIEN                                                        \
    ((uint8_t)0x40) /*!< Transmission Complete Interrupt Enable mask */
#define UART3_CR2_RIEN ((uint8_t)0x20) /*!< Receiver Interrupt Enable mask */
#define UART3_CR2_ILIEN                                                        \
    ((uint8_t)0x10)                   /*!< IDLE Line Interrupt Enable mask     \
                                       */
...
#define UART4_BRR1_DIVM                                                        \
    ((uint8_t)0xFF) /*!< LSB mantissa of UART4DIV [7:0] mask */

#define UART4_BRR2_DIVM                                                        \
    ((uint8_t)0xF0) /*!< MSB mantissa of UART4DIV [11:8] mask */
#define UART4_BRR2_DIVF                                                        \
    ((uint8_t)0x0F) /*!< Fraction bits of UART4DIV [3:0] mask */

#define UART4_CR1_R8 ((uint8_t)0x80) /*!< Receive Data bit 8 */
#define UART4_CR1_T8 ((uint8_t)0x40) /*!< Transmit data bit 8 */
#define UART4_CR1_UARTD                                                        \
    ((uint8_t)0x20) /*!< UART4 Disable (for low power consumption) */
...
#define UART4_CR1_PIEN                                                         \
    ((uint8_t)0x01) /*!< UART4 Parity Interrupt Enable mask */

#define UART4_CR2_TIEN                                                         \
    ((uint8_t)0x80) /*!< Transmitter Interrupt Enable mask                     \
                     */
#define UART4_CR2_TCIEN                                                        \
    ((uint8_t)0x40) /*!< Transmission Complete Interrupt Enable mask */
#define UART4_CR2_RIEN ((uint8_t)0x20) /*!< Receiver Interrupt Enable mask */
#define UART4_CR2_ILIEN                                                        \
    ((uint8_t)0x10)                   /*!< IDLE Line Interrupt Enable mask     \
                                       */
...
#endif /* (STM8S208) ||(STM8S207) || (STM8S007) || (STM8AF52Ax) ||             \
          (STM8AF62Ax) */
...
#endif /* (STM8S208) ||(STM8S207)  || (STM8S105) || (STM8AF52Ax) ||            \
          (STM8AF62Ax) || (STM8AF626x) */
...
#endif /* (STM8S208) ||(STM8S207)  || (STM8S103) || (STM8S903) || (STM8AF52Ax) \
          || (STM8AF62Ax) */
...
#if defined(STM8S208) || defined(STM8S207) || defined(STM8S007) ||             \
  defined(STM8S103) || defined(STM8S003) || defined(STM8S105) ||               \
  defined(STM8S005) || defined(STM8AF52Ax) || defined(STM8AF62Ax) ||           \
  defined(STM8AF626x)
#define TIM2 ((TIM2_TypeDef*)TIM2_BaseAddress)
#endif /* (STM8S208) ||(STM8S207)  || (STM8S103) || (STM8S105) || (STM8AF52Ax) \
          || (STM8AF62Ax) || (STM8AF626x)*/
...
#endif /* (STM8S208) ||(STM8S207)  || (STM8S105) || (STM8AF62Ax) ||            \
          (STM8AF52Ax) || (STM8AF626x)*/
...
#define INTERRUPT_HANDLER(a, b)                                                \
    _Pragma(VECTOR_ID((b) + 2)) __interrupt void(a)(void)
#define INTERRUPT_HANDLER_TRAP(a)                                              \
    _Pragma(VECTOR_ID(1)) __interrupt void(a)(void)
#endif /* _IAR_ */
...
#define BYTE_0(n)                                                              \
    ((uint8_t)((n) & (uint8_t)0xFF)) /*!< Returns the low byte of the 32-bit   \
                                        value */
#define BYTE_1(n)                                                              \
    ((uint8_t)(BYTE_0(                                                         \
      (n) >> (uint8_t)8))) /*!< Returns the second byte of the 32-bit value */
#define BYTE_2(n)                                                              \
    ((uint8_t)(BYTE_0(                                                         \
      (n) >> (uint8_t)16))) /*!< Returns the third byte of the 32-bit value */
#define BYTE_3(n)                                                              \
    ((uint8_t)(BYTE_0(                                                         \
      (n) >> (uint8_t)24))) /*!< Returns the high byte of the 32-bit value */

/*============================== Assert Macros
 * ====================================*/
#define IS_STATE_VALUE_OK(SensitivityValue)                                    \
    (((SensitivityValue) == ENABLE) || ((SensitivityValue) == DISABLE))
...
#define BitClr(BIT)                                                            \
    (*((unsigned char*)(AREA + (BIT) / 8)) &= (~(1 << (7 - (BIT) % 8))))
#define BitSet(BIT)                                                            \
    (*((unsigned char*)(AREA + (BIT) / 8)) |= (1 << (7 - (BIT) % 8)))
#define BitVal(BIT)                                                            \
    (*((unsigned char*)(AREA + (BIT) / 8)) & (1 << (7 - (BIT) % 8)))
