 ...
 * @brief   This file contains all functions prototype and macros for the TIM5
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
#define IS_TIM5_PRESCALER_OK(PRESCALER)                                        \
    (((PRESCALER) == TIM5_PRESCALER_1) || ((PRESCALER) == TIM5_PRESCALER_2) || \
     ((PRESCALER) == TIM5_PRESCALER_4) || ((PRESCALER) == TIM5_PRESCALER_8) || \
...
#define IS_TIM5_OC_MODE_OK(MODE)                                               \
    (((MODE) == TIM5_OCMODE_TIMING) || ((MODE) == TIM5_OCMODE_ACTIVE) ||       \
     ((MODE) == TIM5_OCMODE_INACTIVE) || ((MODE) == TIM5_OCMODE_TOGGLE) ||     \
     ((MODE) == TIM5_OCMODE_PWM1) || ((MODE) == TIM5_OCMODE_PWM2))
...
#define IS_TIM5_IC_PRESCALER_OK(PRESCALER)                                     \
    (((PRESCALER) == TIM5_ICPSC_DIV1) || ((PRESCALER) == TIM5_ICPSC_DIV2) ||   \
     ((PRESCALER) == TIM5_ICPSC_DIV4) || ((PRESCALER) == TIM5_ICPSC_DIV8))
...
#define IS_TIM5_GET_IT_OK(IT)                                                  \
    (((IT) == TIM5_IT_UPDATE) || ((IT) == TIM5_IT_CC1) ||                      \
     ((IT) == TIM5_IT_CC2) || ((IT) == TIM5_IT_CC3) ||                         \
     ((IT) == TIM5_IT_TRIGGER))
...
typedef enum
{
    TIM5_TRGOSOURCE_RESET =
      ((uint8_t)0x00), /*!< Trigger Output source = Reset*/
    TIM5_TRGOSOURCE_ENABLE =
      ((uint8_t)0x10), /*!< Trigger Output source = TIM5 is enabled*/
    TIM5_TRGOSOURCE_UPDATE =
      ((uint8_t)0x20), /*!< Trigger Output source = Update event*/
    TIM5_TRGOSOURCE_OC1 =
      ((uint8_t)0x30), /*!< Trigger Output source = output compare channel1  */
    TIM5_TRGOSOURCE_OC1REF =
      ((uint8_t)0x40), /*!< Trigger Output source = output compare channel 1
                          reference */
    TIM5_TRGOSOURCE_OC2REF = ((uint8_t)0x50) /*!< Trigger Output source = output
                                                compare channel 2 reference */
...
#define IS_TIM5_GET_FLAG_OK(FLAG)                                              \
    (((FLAG) == TIM5_FLAG_UPDATE) || ((FLAG) == TIM5_FLAG_CC1) ||              \
     ((FLAG) == TIM5_FLAG_CC2) || ((FLAG) == TIM5_FLAG_CC3) ||                 \
     ((FLAG) == TIM5_FLAG_TRIGGER) || ((FLAG) == TIM5_FLAG_CC1OF) ||           \
...
typedef enum
{
    ...
    TIM5_SLAVEMODE_TRIGGER =
      ((uint8_t)0x06), /*!< Slave Mode Selection  = Trigger*/
    TIM5_SLAVEMODE_EXTERNAL1 =
      ((uint8_t)0x07) /*!< Slave Mode Selection  = External 1*/
...
#define IS_TIM5_SLAVE_MODE_OK(MODE)                                            \
    (((MODE) == TIM5_SLAVEMODE_RESET) || ((MODE) == TIM5_SLAVEMODE_GATED) ||   \
...
#define IS_TIM5_TIX_TRIGGER_SELECTION_OK(SELECTION)                            \
    (((SELECTION) == TIM5_TS_TI1F_ED) || ((SELECTION) == TIM5_TS_TI1FP1) ||    \
...
#define IS_TIM5_ENCODER_MODE_OK(MODE)                                          \
    (((MODE) == TIM5_ENCODERMODE_TI1) || ((MODE) == TIM5_ENCODERMODE_TI2) ||   \
...
typedef enum
{
    ...
    TIM5_EXTTRGPSC_DIV2 = ((uint8_t)0x10), /*!< External Trigger prescaler = 2
                                              (ETRP frequency divided by 2) */
    TIM5_EXTTRGPSC_DIV4 = ((uint8_t)0x20), /*!< External Trigger prescaler = 4
                                              (ETRP frequency divided by 4) */
    TIM5_EXTTRGPSC_DIV8 = ((uint8_t)0x30)  /*!< External Trigger prescaler = 8
...
typedef enum
{
    TIM5_EXTTRGPOLARITY_INVERTED =
      ((uint8_t)0x80), /*!< External Trigger Polarity = inverted */
    TIM5_EXTTRGPOLARITY_NONINVERTED =
      ((uint8_t)0x00) /*!< External Trigger Polarity = non inverted */
