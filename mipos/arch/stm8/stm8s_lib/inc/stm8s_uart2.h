 ...
 * @brief   This file contains all functions prototypes and macros for the UART2
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
typedef enum
{
    UART2_IRDAMODE_NORMAL = (uint8_t)0x00,  /**< 0x00 Irda Normal Mode   */
...
typedef enum
{
    UART2_WAKEUP_IDLELINE = (uint8_t)0x00,   /**< 0x01 Idle Line wake up */
...
typedef enum
{
    UART2_LINBREAKDETECTIONLENGTH_10BITS =
      (uint8_t)0x00, /**< 0x01 10 bits Lin Break detection */
    UART2_LINBREAKDETECTIONLENGTH_11BITS =
      (uint8_t)0x01 /**< 0x02 11 bits Lin Break detection */
...
{
    UART2_STOPBITS_1 =
      (uint8_t)0x00, /**< One stop bit is  transmitted at the end of frame*/
    UART2_STOPBITS_0_5 =
      (uint8_t)0x10, /**< Half stop bits is transmitted at the end of frame*/
    UART2_STOPBITS_2 =
      (uint8_t)0x20, /**< Two stop bits are  transmitted at the end of frame*/
...
typedef enum
{
    UART2_LIN_MODE_MASTER = (uint8_t)0x00, /**<  LIN Master Mode*/
...
typedef enum
{
    UART2_LIN_AUTOSYNC_DISABLE =
      (uint8_t)0x00, /**< LIN Autosynchronization Disable*/
    UART2_LIN_AUTOSYNC_ENABLE =
      (uint8_t)0x01 /**< LIN Autosynchronization Enable*/
...
typedef enum
{
    UART2_LIN_DIVUP_LBRR1 =
      (uint8_t)0x00, /**<  LIN LDIV is updated as soon as LBRR1 is written*/
    UART2_LIN_DIVUP_NEXTRXNE =
      (uint8_t)0x01 /**<  LIN LDIV is updated at the next received character*/
...
typedef enum
{
    UART2_SYNCMODE_CLOCK_DISABLE =
      (uint8_t)0x80, /**< 0x80 Sync mode Disable, SLK pin Disable */
    UART2_SYNCMODE_CLOCK_ENABLE =
      (uint8_t)0x08, /**< 0x08 Sync mode Enable, SLK pin Enable     */
    UART2_SYNCMODE_CPOL_LOW =
      (uint8_t)0x40, /**< 0x40 Steady low value on SCLK pin outside transmission
                        window */
    UART2_SYNCMODE_CPOL_HIGH =
      (uint8_t)0x04, /**< 0x04 Steady high value on SCLK pin outside
                        transmission window */
    UART2_SYNCMODE_CPHA_MIDDLE =
      (uint8_t)0x20, /**< 0x20 SCLK clock line activated in middle of data bit
                      */
    UART2_SYNCMODE_CPHA_BEGINING =
      (uint8_t)0x02, /**< 0x02 SCLK clock line activated at beginning of data
                        bit  */
    UART2_SYNCMODE_LASTBIT_DISABLE =
      (uint8_t)0x10, /**< 0x10 The clock pulse of the last data bit is not
                        output to the SCLK pin */
    UART2_SYNCMODE_LASTBIT_ENABLE =
      (uint8_t)0x01 /**< 0x01 The clock pulse of the last data bit is output to
                       the SCLK pin */
...
typedef enum
{
    UART2_WORDLENGTH_8D = (uint8_t)0x00, /**< 0x00 8 bits Data  */
...
typedef enum
{
    UART2_MODE_RX_ENABLE = (uint8_t)0x08,  /**< 0x08 Receive Enable */
    ...
    UART2_MODE_RX_DISABLE =
      (uint8_t)0x40, /**< 0x40 Single-wire Half-duplex mode */
    UART2_MODE_TXRX_ENABLE =
      (uint8_t)0x0C /**< 0x0C Transmit Enable and Receive Enable */
} UART2_Mode_TypeDef;
/**
...
typedef enum
{
    ...
    UART2_FLAG_RXNE =
      (uint16_t)0x0020, /*!< Read Data Register Not Empty flag */
    ...
    UART2_FLAG_SBK =
      (uint16_t)0x0101, /**< Send Break Complete interrupt flag */
 ...
 *   - For the following values, X means the interrupt position in the CR2
 * register. UART2_IT_TXE UART2_IT_TC UART2_IT_RXNE UART2_IT_IDLE UART2_IT_OR
 *   - For the UART2_IT_PE value, X means the flag position in the CR1 register.
 *   - For the UART2_IT_LBDF value, X means the flag position in the CR4
 * register.
 *   - For the UART2_IT_LHDF value, X means the flag position in the CR6
 * register. Y: Flag position
 *  - For the following values, Y means the flag (pending bit) position in the
 * SR register. UART2_IT_TXE UART2_IT_TC UART2_IT_RXNE UART2_IT_IDLE UART2_IT_OR
 *     UART2_IT_PE
 *  - For the UART2_IT_LBDF value, Y means the flag position in the CR4
 * register.
 *  - For the UART2_IT_LHDF value, Y means the flag position in the CR6
 * register. Z: Register index: indicate in which register the dedicated
 * interrupt source is:
 *  - 1==> CR1 register
 *  - 2==> CR2 register
 *  - 3==> CR4 register
...
typedef enum
{
    UART2_IT_TXE = (uint16_t)0x0277,  /**< Transmit interrupt */
...
/**
 * @brief  Macro used by the assert function to check the different functions
 * parameters.
 */

/**
 * @brief Macro used by the assert_param function in order to check the
 * different sensitivity values for the MODEs possible combination should be one
 * of the following.
 */
...
#define IS_UART2_MODE_OK(Mode)                                                 \
    (((Mode) == (uint8_t)UART2_MODE_RX_ENABLE) ||                              \
     ...
     ((Mode) == (uint8_t)((uint8_t)UART2_MODE_TX_ENABLE |                      \
                          (uint8_t)UART2_MODE_RX_ENABLE)) ||                   \
     ((Mode) == (uint8_t)((uint8_t)UART2_MODE_TX_ENABLE |                      \
                          (uint8_t)UART2_MODE_RX_DISABLE)) ||                  \
     ((Mode) == (uint8_t)((uint8_t)UART2_MODE_TX_DISABLE |                     \
                          (uint8_t)UART2_MODE_RX_DISABLE)) ||                  \
     ((Mode) == (uint8_t)((uint8_t)UART2_MODE_TX_DISABLE |                     \
                          (uint8_t)UART2_MODE_RX_ENABLE)))
...
/**
 * @brief Macro used by the assert_param function in order to check the
 * different sensitivity values for the WordLengths
 */
...
/**
 * @brief  Macro used by the assert_param function in order to check the
 * different sensitivity values for the SyncModes; it should exclude values such
 *         as  UART2_CLOCK_ENABLE|UART2_CLOCK_DISABLE
 */
#define IS_UART2_SYNCMODE_OK(SyncMode)                                         \
    (!((((SyncMode) & (((uint8_t)UART2_SYNCMODE_CLOCK_ENABLE) |                \
                       ((uint8_t)UART2_SYNCMODE_CLOCK_DISABLE))) ==            \
        (((uint8_t)UART2_SYNCMODE_CLOCK_ENABLE) |                              \
         ((uint8_t)UART2_SYNCMODE_CLOCK_DISABLE))) ||                          \
       (((SyncMode) & (((uint8_t)UART2_SYNCMODE_CPOL_LOW) |                    \
                       ((uint8_t)UART2_SYNCMODE_CPOL_HIGH))) ==                \
        (((uint8_t)UART2_SYNCMODE_CPOL_LOW) |                                  \
         ((uint8_t)UART2_SYNCMODE_CPOL_HIGH))) ||                              \
       (((SyncMode) & (((uint8_t)UART2_SYNCMODE_CPHA_MIDDLE) |                 \
                       ((uint8_t)UART2_SYNCMODE_CPHA_BEGINING))) ==            \
        (((uint8_t)UART2_SYNCMODE_CPHA_MIDDLE) |                               \
         ((uint8_t)UART2_SYNCMODE_CPHA_BEGINING))) ||                          \
       (((SyncMode) & (((uint8_t)UART2_SYNCMODE_LASTBIT_DISABLE) |             \
                       ((uint8_t)UART2_SYNCMODE_LASTBIT_ENABLE))) ==           \
        (((uint8_t)UART2_SYNCMODE_LASTBIT_DISABLE) |                           \
         ((uint8_t)UART2_SYNCMODE_LASTBIT_ENABLE)))))
...
#define IS_UART2_FLAG_OK(Flag)                                                 \
    (((Flag) == UART2_FLAG_TXE) || ((Flag) == UART2_FLAG_TC) ||                \
     ((Flag) == UART2_FLAG_RXNE) || ((Flag) == UART2_FLAG_IDLE) ||             \
     ((Flag) == UART2_FLAG_OR_LHE) || ((Flag) == UART2_FLAG_NF) ||             \
     ((Flag) == UART2_FLAG_FE) || ((Flag) == UART2_FLAG_PE) ||                 \
     ((Flag) == UART2_FLAG_SBK) || ((Flag) == UART2_FLAG_LSF) ||               \
     ((Flag) == UART2_FLAG_LHDF) || ((Flag) == UART2_FLAG_LBDF))


/**
 * @brief  Macro used by the assert_param function in order to check the
 *         different sensitivity values for the FLAGs that can be cleared by
 * writing 0
 */
#define IS_UART2_CLEAR_FLAG_OK(Flag)                                           \
    (((Flag) == UART2_FLAG_RXNE) || ((Flag) == UART2_FLAG_LHDF) ||             \
     ((Flag) == UART2_FLAG_LSF) || ((Flag) == UART2_FLAG_LBDF))
...
#define IS_UART2_CONFIG_IT_OK(Interrupt)                                       \
    (((Interrupt) == UART2_IT_PE) || ((Interrupt) == UART2_IT_TXE) ||          \
     ((Interrupt) == UART2_IT_TC) || ((Interrupt) == UART2_IT_RXNE_OR) ||      \
     ((Interrupt) == UART2_IT_IDLE) || ((Interrupt) == UART2_IT_LHDF) ||       \
...
#define IS_UART2_GET_IT_OK(ITPendingBit)                                       \
    (((ITPendingBit) == UART2_IT_TXE) || ((ITPendingBit) == UART2_IT_TC) ||    \
     ((ITPendingBit) == UART2_IT_RXNE) || ((ITPendingBit) == UART2_IT_IDLE) || \
     ((ITPendingBit) == UART2_IT_OR) || ((ITPendingBit) == UART2_IT_LBDF) ||   \
     ((ITPendingBit) == UART2_IT_LHDF) || ((ITPendingBit) == UART2_IT_PE))

/**
 * @brief  Macro used by the assert function in order to check the different
 *         sensitivity values for the pending bit that can be cleared by writing
 * 0
 */
#define IS_UART2_CLEAR_IT_OK(ITPendingBit)                                     \
    (((ITPendingBit) == UART2_IT_RXNE) || ((ITPendingBit) == UART2_IT_LHDF) || \
     ((ITPendingBit) == UART2_IT_LBDF))


/**
 * @brief Macro used by the assert_param function in order to check the
 * different sensitivity values for the IrDAModes
 */
...
/**
 * @brief  Macro used by the assert_param function in order to check the
 * different sensitivity values for the WakeUps
 */
...
/**
 * @brief  Macro used by the assert_param function in order to check the
 * different sensitivity values for the LINBreakDetectionLengths
 */
...
/**
 * @brief  Macro used by the assert_param function in order to check the
 * different sensitivity values for the UART2_StopBits
 */
#define IS_UART2_STOPBITS_OK(StopBit)                                          \
    (((StopBit) == UART2_STOPBITS_1) || ((StopBit) == UART2_STOPBITS_0_5) ||   \
     ((StopBit) == UART2_STOPBITS_2) || ((StopBit) == UART2_STOPBITS_1_5))

/**
 * @brief Macro used by the assert_param function in order to check the
 * different sensitivity values for the Paritys
 */
#define IS_UART2_PARITY_OK(Parity)                                             \
    (((Parity) == UART2_PARITY_NO) || ((Parity) == UART2_PARITY_EVEN) ||       \
...
#define IS_UART2_SLAVE_OK(Mode)                                                \
    (((Mode) == UART2_LIN_MODE_MASTER) || ((Mode) == UART2_LIN_MODE_SLAVE))
...
void UART2_LINBreakDetectionConfig(
  UART2_LINBreakDetectionLength_TypeDef UART2_LINBreakDetectionLength);
