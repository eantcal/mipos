 ...
 * @brief  This file contains all functions prototype and macros for the TIM3
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
#define IS_TIM3_PRESCALER_OK(PRESCALER)                                        \
    (((PRESCALER) == TIM3_PRESCALER_1) || ((PRESCALER) == TIM3_PRESCALER_2) || \
     ((PRESCALER) == TIM3_PRESCALER_4) || ((PRESCALER) == TIM3_PRESCALER_8) || \
...
#define IS_TIM3_OC_MODE_OK(MODE)                                               \
    (((MODE) == TIM3_OCMODE_TIMING) || ((MODE) == TIM3_OCMODE_ACTIVE) ||       \
     ((MODE) == TIM3_OCMODE_INACTIVE) || ((MODE) == TIM3_OCMODE_TOGGLE) ||     \
     ((MODE) == TIM3_OCMODE_PWM1) || ((MODE) == TIM3_OCMODE_PWM2))
...
#define IS_TIM3_IC_PRESCALER_OK(PRESCALER)                                     \
    (((PRESCALER) == TIM3_ICPSC_DIV1) || ((PRESCALER) == TIM3_ICPSC_DIV2) ||   \
     ((PRESCALER) == TIM3_ICPSC_DIV4) || ((PRESCALER) == TIM3_ICPSC_DIV8))
...
#define IS_TIM3_GET_FLAG_OK(FLAG)                                              \
    (((FLAG) == TIM3_FLAG_UPDATE) || ((FLAG) == TIM3_FLAG_CC1) ||              \
     ((FLAG) == TIM3_FLAG_CC2) || ((FLAG) == TIM3_FLAG_CC1OF) ||               \
     ((FLAG) == TIM3_FLAG_CC2OF))

#define IS_TIM3_CLEAR_FLAG_OK(FLAG)                                            \
    ((((uint16_t)(FLAG)&0xF9F8) == 0x0000) && ((uint16_t)(FLAG) != 0x0000))
