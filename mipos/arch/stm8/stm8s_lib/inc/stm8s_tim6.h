 ...
 * @brief   This file contains all functions prototype and macros for the TIM6
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
{
    TIM6_PRESCALER_1 =
      ((uint8_t)0x00), /*!< Time base Prescaler = 1 (No effect)*/
...
{
    TIM6_OPMODE_SINGLE =
      ((uint8_t)0x01), /*!< Single one Pulse mode (OPM Active) */
    TIM6_OPMODE_REPETITIVE =
      ((uint8_t)0x00) /*!< Repetitive Pulse mode (OPM inactive) */
} TIM6_OPMode_TypeDef;
...
typedef enum
{
    TIM6_PSCRELOADMODE_UPDATE =
      ((uint8_t)0x00), /*!< Prescaler value is reloaded at every update*/
    TIM6_PSCRELOADMODE_IMMEDIATE =
      ((uint8_t)0x01) /*!< Prescaler value is reloaded immediately*/
...
typedef enum
{
    TIM6_UPDATESOURCE_GLOBAL =
      ((uint8_t)0x00), /*!< Global Update request source */
    TIM6_UPDATESOURCE_REGULAR =
      ((uint8_t)0x01) /*!< Regular Update request source */
...
typedef enum
{
    TIM6_SLAVEMODE_DISABLE =
      ((uint8_t)0x00), /*!< Disable slave mode to clock the prescaler directly
...
{
    TIM6_TS_TIM1 =
      ((uint8_t)0x20), /*!< TRIG Input source =  TIM1 TRIG Output  */
...
#define IS_TIM6_PRESCALER_OK(PRESCALER)                                        \
    (((PRESCALER) == TIM6_PRESCALER_1) || ((PRESCALER) == TIM6_PRESCALER_2) || \
     ((PRESCALER) == TIM6_PRESCALER_4) || ((PRESCALER) == TIM6_PRESCALER_8) || \
...
#define IS_TIM6_SLAVE_MODE_OK(MODE)                                            \
    (((MODE) == TIM6_SLAVEMODE_DISABLE) || ((MODE) == TIM6_SLAVEMODE_RESET) || \
     ((MODE) == TIM6_SLAVEMODE_GATED) || ((MODE) == TIM6_SLAVEMODE_TRIGGER) || \
...
#define IS_TIM6_IT_OK(IT)                                                      \
    (((IT) != 0x00) && (((IT) & (uint8_t)(~(uint8_t)(0x41))) == 0x00))
