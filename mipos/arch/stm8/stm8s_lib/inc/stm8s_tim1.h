 ...
 * @brief   This file contains all functions prototype and macros for the TIM1
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
#define IS_TIM1_OC_MODE_OK(MODE)                                               \
    (((MODE) == TIM1_OCMODE_TIMING) || ((MODE) == TIM1_OCMODE_ACTIVE) ||       \
     ((MODE) == TIM1_OCMODE_INACTIVE) || ((MODE) == TIM1_OCMODE_TOGGLE) ||     \
     ((MODE) == TIM1_OCMODE_PWM1) || ((MODE) == TIM1_OCMODE_PWM2))
...
#define IS_TIM1_OPM_MODE_OK(MODE)                                              \
    (((MODE) == TIM1_OPMODE_SINGLE) || ((MODE) == TIM1_OPMODE_REPETITIVE))
...
#define IS_TIM1_CHANNEL_OK(CHANNEL)                                            \
    (((CHANNEL) == TIM1_CHANNEL_1) || ((CHANNEL) == TIM1_CHANNEL_2) ||         \
     ((CHANNEL) == TIM1_CHANNEL_3) || ((CHANNEL) == TIM1_CHANNEL_4))
...
#define IS_TIM1_COUNTER_MODE_OK(MODE)                                          \
    (((MODE) == TIM1_COUNTERMODE_UP) || ((MODE) == TIM1_COUNTERMODE_DOWN) ||   \
...
#define IS_TIM1_BREAK_STATE_OK(STATE)                                          \
    (((STATE) == TIM1_BREAK_ENABLE) || ((STATE) == TIM1_BREAK_DISABLE))
...
#define IS_TIM1_LOCK_LEVEL_OK(LEVEL)                                           \
    (((LEVEL) == TIM1_LOCKLEVEL_OFF) || ((LEVEL) == TIM1_LOCKLEVEL_1) ||       \
     ((LEVEL) == TIM1_LOCKLEVEL_2) || ((LEVEL) == TIM1_LOCKLEVEL_3))
...
#define IS_TIM1_OSSI_STATE_OK(STATE)                                           \
    (((STATE) == TIM1_OSSISTATE_ENABLE) || ((STATE) == TIM1_OSSISTATE_DISABLE))
...
#define IS_TIM1_OCIDLE_STATE_OK(STATE)                                         \
    (((STATE) == TIM1_OCIDLESTATE_SET) || ((STATE) == TIM1_OCIDLESTATE_RESET))
...
#define IS_TIM1_OCNIDLE_STATE_OK(STATE)                                        \
    (((STATE) == TIM1_OCNIDLESTATE_SET) || ((STATE) == TIM1_OCNIDLESTATE_RESET))
...
#define IS_TIM1_IC_PRESCALER_OK(PRESCALER)                                     \
    (((PRESCALER) == TIM1_ICPSC_DIV1) || ((PRESCALER) == TIM1_ICPSC_DIV2) ||   \
     ((PRESCALER) == TIM1_ICPSC_DIV4) || ((PRESCALER) == TIM1_ICPSC_DIV8))
...
#define IS_TIM1_GET_IT_OK(IT)                                                  \
    (((IT) == TIM1_IT_UPDATE) || ((IT) == TIM1_IT_CC1) ||                      \
     ((IT) == TIM1_IT_CC2) || ((IT) == TIM1_IT_CC3) ||                         \
     ((IT) == TIM1_IT_CC4) || ((IT) == TIM1_IT_COM) ||                         \
     ((IT) == TIM1_IT_TRIGGER) || ((IT) == TIM1_IT_BREAK))
...
{
    TIM1_TS_TIM6 =
      ((uint8_t)0x00), /*!< TRIG Input source =  TIM6 TRIG Output  */
    TIM1_TS_TIM5 =
      ((uint8_t)0x30), /*!< TRIG Input source =  TIM5 TRIG Output  */
...
#define IS_TIM1_TRIGGER_SELECTION_OK(SELECTION)                                \
    (((SELECTION) == TIM1_TS_TI1F_ED) || ((SELECTION) == TIM1_TS_TI1FP1) ||    \
     ((SELECTION) == TIM1_TS_TI2FP2) || ((SELECTION) == TIM1_TS_ETRF) ||       \
     ((SELECTION) == TIM1_TS_TIM5) || ((SELECTION) == TIM1_TS_TIM6))
...
#define IS_TIM1_ENCODER_MODE_OK(MODE)                                          \
    (((MODE) == TIM1_ENCODERMODE_TI1) || ((MODE) == TIM1_ENCODERMODE_TI2) ||   \
...
#define IS_TIM1_SLAVE_MODE_OK(MODE)                                            \
    (((MODE) == TIM1_SLAVEMODE_RESET) || ((MODE) == TIM1_SLAVEMODE_GATED) ||   \
...
#define IS_TIM1_GET_FLAG_OK(FLAG)                                              \
    (((FLAG) == TIM1_FLAG_UPDATE) || ((FLAG) == TIM1_FLAG_CC1) ||              \
     ((FLAG) == TIM1_FLAG_CC2) || ((FLAG) == TIM1_FLAG_CC3) ||                 \
     ((FLAG) == TIM1_FLAG_CC4) || ((FLAG) == TIM1_FLAG_COM) ||                 \
     ((FLAG) == TIM1_FLAG_TRIGGER) || ((FLAG) == TIM1_FLAG_BREAK) ||           \
     ((FLAG) == TIM1_FLAG_CC1OF) || ((FLAG) == TIM1_FLAG_CC2OF) ||             \
     ((FLAG) == TIM1_FLAG_CC3OF) || ((FLAG) == TIM1_FLAG_CC4OF))

#define IS_TIM1_CLEAR_FLAG_OK(FLAG)                                            \
    ((((uint16_t)(FLAG) & (uint16_t)0xE100) == 0x0000) && ((FLAG) != 0x0000))
