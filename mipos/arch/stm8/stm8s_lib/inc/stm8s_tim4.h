 ...
 * @brief   This file contains all functions prototype and macros for the TIM4
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
#define IS_TIM4_PRESCALER_OK(PRESCALER)                                        \
    (((PRESCALER) == TIM4_PRESCALER_1) || ((PRESCALER) == TIM4_PRESCALER_2) || \
     ((PRESCALER) == TIM4_PRESCALER_4) || ((PRESCALER) == TIM4_PRESCALER_8) || \
