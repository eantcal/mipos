 ...
 * @brief   This file contains all the prototypes/macros for the ADC1
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
typedef enum
{
    ADC1_PRESSEL_FCPU_D2 =
      (uint8_t)0x00, /**< Prescaler selection fADC1 = fcpu/2 */
    ADC1_PRESSEL_FCPU_D3 =
      (uint8_t)0x10, /**< Prescaler selection fADC1 = fcpu/3 */
    ADC1_PRESSEL_FCPU_D4 =
      (uint8_t)0x20, /**< Prescaler selection fADC1 = fcpu/4 */
    ADC1_PRESSEL_FCPU_D6 =
      (uint8_t)0x30, /**< Prescaler selection fADC1 = fcpu/6 */
    ADC1_PRESSEL_FCPU_D8 =
      (uint8_t)0x40, /**< Prescaler selection fADC1 = fcpu/8 */
    ADC1_PRESSEL_FCPU_D10 =
      (uint8_t)0x50, /**< Prescaler selection fADC1 = fcpu/10 */
    ADC1_PRESSEL_FCPU_D12 =
      (uint8_t)0x60, /**< Prescaler selection fADC1 = fcpu/12 */
    ADC1_PRESSEL_FCPU_D18 =
      (uint8_t)0x70 /**< Prescaler selection fADC1 = fcpu/18 */
...
{
    ADC1_EXTTRIG_TIM =
      (uint8_t)0x00, /**< Conversion from Internal TIM1 TRGO event */
    ADC1_EXTTRIG_GPIO =
      (uint8_t)0x10 /**< Conversion from External interrupt on ADC_ETR pin*/
...
typedef enum
{
    ADC1_SCHMITTTRIG_CHANNEL0 =
      (uint8_t)0x00, /**< Schmitt trigger disable on AIN0 */
    ADC1_SCHMITTTRIG_CHANNEL1 =
      (uint8_t)0x01, /**< Schmitt trigger disable on AIN1 */
    ADC1_SCHMITTTRIG_CHANNEL2 =
      (uint8_t)0x02, /**< Schmitt trigger disable on AIN2 */
    ADC1_SCHMITTTRIG_CHANNEL3 =
      (uint8_t)0x03, /**< Schmitt trigger disable on AIN3 */
    ADC1_SCHMITTTRIG_CHANNEL4 =
      (uint8_t)0x04, /**< Schmitt trigger disable on AIN4 */
    ADC1_SCHMITTTRIG_CHANNEL5 =
      (uint8_t)0x05, /**< Schmitt trigger disable on AIN5 */
    ADC1_SCHMITTTRIG_CHANNEL6 =
      (uint8_t)0x06, /**< Schmitt trigger disable on AIN6 */
    ADC1_SCHMITTTRIG_CHANNEL7 =
      (uint8_t)0x07, /**< Schmitt trigger disable on AIN7 */
    ADC1_SCHMITTTRIG_CHANNEL8 =
      (uint8_t)0x08, /**< Schmitt trigger disable on AIN8 */
    ADC1_SCHMITTTRIG_CHANNEL9 =
      (uint8_t)0x09, /**< Schmitt trigger disable on AIN9 */
    ADC1_SCHMITTTRIG_CHANNEL12 =
      (uint8_t)0x0C, /**< Schmitt trigger disable on AIN12 */
    /* refer to product datasheet for channel 12 availability */
    ADC1_SCHMITTTRIG_ALL =
      (uint8_t)0xFF /**< Schmitt trigger disable on All channels */
...
typedef enum
{
    ...
    ADC1_CONVERSIONMODE_CONTINUOUS =
      (uint8_t)0x01 /**< Continuous conversion mode */
 ...
 * @brief  Macros used by the assert function to check the different functions
 * parameters.
 * @{
 */

/**
 * @brief  Macro used by the assert function to check the different prescaler's
 * values.
 */
...
/**
 * @brief  Macro used by the assert function to check the different external
 * trigger values.
 */
#define IS_ADC1_EXTTRIG_OK(EXTRIG)                                             \
    (((EXTRIG) == ADC1_EXTTRIG_TIM) || ((EXTRIG) == ADC1_EXTTRIG_GPIO))

/**
 * @brief  Macro used by the assert function to check the different alignment
 * modes.
 */
#define IS_ADC1_ALIGN_OK(ALIGN)                                                \
    (((ALIGN) == ADC1_ALIGN_LEFT) || ((ALIGN) == ADC1_ALIGN_RIGHT))

/**
 * @brief  Macro used by the assert function to check the Interrupt source.
 */
#define IS_ADC1_IT_OK(IT) (((IT) == ADC1_IT_EOCIE) || ((IT) == ADC1_IT_AWDIE))

/**
 * @brief  Macro used by the assert function to check the ADC1 Flag.
 */
#define IS_ADC1_FLAG_OK(FLAG)                                                  \
    (((FLAG) == ADC1_FLAG_EOC) || ((FLAG) == ADC1_FLAG_OVR) ||                 \
     ((FLAG) == ADC1_FLAG_AWD) || ((FLAG) == ADC1_FLAG_AWS0) ||                \
     ((FLAG) == ADC1_FLAG_AWS1) || ((FLAG) == ADC1_FLAG_AWS2) ||               \
     ((FLAG) == ADC1_FLAG_AWS3) || ((FLAG) == ADC1_FLAG_AWS4) ||               \
     ((FLAG) == ADC1_FLAG_AWS5) || ((FLAG) == ADC1_FLAG_AWS6) ||               \
     ((FLAG) == ADC1_FLAG_AWS7) || ((FLAG) == ADC1_FLAG_AWS8) ||               \
     ((FLAG) == ADC1_FLAG_AWS9))
...
#define IS_ADC1_ITPENDINGBIT_OK(ITPENDINGBIT)                                  \
    (((ITPENDINGBIT) == ADC1_IT_EOC) || ((ITPENDINGBIT) == ADC1_IT_AWD) ||     \
     ((ITPENDINGBIT) == ADC1_IT_AWS0) || ((ITPENDINGBIT) == ADC1_IT_AWS1) ||   \
     ((ITPENDINGBIT) == ADC1_IT_AWS2) || ((ITPENDINGBIT) == ADC1_IT_AWS3) ||   \
     ((ITPENDINGBIT) == ADC1_IT_AWS4) || ((ITPENDINGBIT) == ADC1_IT_AWS5) ||   \
     ((ITPENDINGBIT) == ADC1_IT_AWS6) || ((ITPENDINGBIT) == ADC1_IT_AWS7) ||   \
     ((ITPENDINGBIT) == ADC1_IT_AWS8) || ((ITPENDINGBIT) == ADC1_IT_AWS12) ||  \
     ((ITPENDINGBIT) == ADC1_IT_AWS9))

/**
 * @brief  Macro used by the assert function to check the different schmitt
 * trigger values.
 */
...
/**
 * @brief  Macro used by the assert function to check the different conversion
 * modes.
 */
#define IS_ADC1_CONVERSIONMODE_OK(MODE)                                        \
    (((MODE) == ADC1_CONVERSIONMODE_SINGLE) ||                                 \
     ((MODE) == ADC1_CONVERSIONMODE_CONTINUOUS))

/**
 * @brief  Macro used by the assert function to check the different channels
 * values.
 */
#define IS_ADC1_CHANNEL_OK(CHANNEL)                                            \
    (((CHANNEL) == ADC1_CHANNEL_0) || ((CHANNEL) == ADC1_CHANNEL_1) ||         \
     ((CHANNEL) == ADC1_CHANNEL_2) || ((CHANNEL) == ADC1_CHANNEL_3) ||         \
     ((CHANNEL) == ADC1_CHANNEL_4) || ((CHANNEL) == ADC1_CHANNEL_5) ||         \
     ((CHANNEL) == ADC1_CHANNEL_6) || ((CHANNEL) == ADC1_CHANNEL_7) ||         \
     ((CHANNEL) == ADC1_CHANNEL_8) || ((CHANNEL) == ADC1_CHANNEL_12) ||        \
     ((CHANNEL) == ADC1_CHANNEL_9))

/**
 * @brief  Macro used by the assert function to check the possible buffer
 * values.
 */
