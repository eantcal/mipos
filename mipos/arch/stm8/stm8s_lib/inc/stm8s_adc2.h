 ...
 * @brief   This file contains all the prototypes/macros for the ADC2
 *peripheral.
 ******************************************************************************
 * @attention
 *
...
typedef enum
{
    ADC2_PRESSEL_FCPU_D2 =
      (uint8_t)0x00, /**< Prescaler selection fADC2 = fcpu/2 */
    ADC2_PRESSEL_FCPU_D3 =
      (uint8_t)0x10, /**< Prescaler selection fADC2 = fcpu/3 */
    ADC2_PRESSEL_FCPU_D4 =
      (uint8_t)0x20, /**< Prescaler selection fADC2 = fcpu/4 */
    ADC2_PRESSEL_FCPU_D6 =
      (uint8_t)0x30, /**< Prescaler selection fADC2 = fcpu/6 */
    ADC2_PRESSEL_FCPU_D8 =
      (uint8_t)0x40, /**< Prescaler selection fADC2 = fcpu/8 */
    ADC2_PRESSEL_FCPU_D10 =
      (uint8_t)0x50, /**< Prescaler selection fADC2 = fcpu/10 */
    ADC2_PRESSEL_FCPU_D12 =
      (uint8_t)0x60, /**< Prescaler selection fADC2 = fcpu/12 */
    ADC2_PRESSEL_FCPU_D18 =
      (uint8_t)0x70 /**< Prescaler selection fADC2 = fcpu/18 */
...
{
    ADC2_EXTTRIG_TIM =
      (uint8_t)0x00, /**< Conversion from Internal TIM TRGO event */
    ADC2_EXTTRIG_GPIO =
      (uint8_t)0x01 /**< Conversion from External interrupt on ADC_ETR pin*/
...
typedef enum
{
    ...
    ADC2_SCHMITTTRIG_CHANNEL10 =
      (uint8_t)0x0A, /**< Schmitt trigger disable on AIN10 */
    ADC2_SCHMITTTRIG_CHANNEL11 =
      (uint8_t)0x0B, /**< Schmitt trigger disable on AIN11 */
    ADC2_SCHMITTTRIG_CHANNEL12 =
      (uint8_t)0x0C, /**< Schmitt trigger disable on AIN12 */
    ADC2_SCHMITTTRIG_CHANNEL13 =
      (uint8_t)0x0D, /**< Schmitt trigger disable on AIN13 */
    ADC2_SCHMITTTRIG_CHANNEL14 =
      (uint8_t)0x0E, /**< Schmitt trigger disable on AIN14 */
    ADC2_SCHMITTTRIG_CHANNEL15 =
      (uint8_t)0x0F, /**< Schmitt trigger disable on AIN15 */
    ADC2_SCHMITTTRIG_ALL =
      (uint8_t)0x1F /**< Schmitt trigger disable on all channels */
...
#define IS_ADC2_EXTTRIG_OK(EXTRIG)                                             \
    (((EXTRIG) == ADC2_EXTTRIG_TIM) || ((EXTRIG) == ADC2_EXTTRIG_GPIO))
...
#define IS_ADC2_ALIGN_OK(ALIGN)                                                \
    (((ALIGN) == ADC2_ALIGN_LEFT) || ((ALIGN) == ADC2_ALIGN_RIGHT))
...
#define IS_ADC2_CONVERSIONMODE_OK(MODE)                                        \
    (((MODE) == ADC2_CONVERSIONMODE_SINGLE) ||                                 \
...
#define IS_ADC2_CHANNEL_OK(CHANNEL)                                            \
    (((CHANNEL) == ADC2_CHANNEL_0) || ((CHANNEL) == ADC2_CHANNEL_1) ||         \
     ((CHANNEL) == ADC2_CHANNEL_2) || ((CHANNEL) == ADC2_CHANNEL_3) ||         \
     ((CHANNEL) == ADC2_CHANNEL_4) || ((CHANNEL) == ADC2_CHANNEL_5) ||         \
     ((CHANNEL) == ADC2_CHANNEL_6) || ((CHANNEL) == ADC2_CHANNEL_7) ||         \
     ((CHANNEL) == ADC2_CHANNEL_8) || ((CHANNEL) == ADC2_CHANNEL_9) ||         \
     ((CHANNEL) == ADC2_CHANNEL_10) || ((CHANNEL) == ADC2_CHANNEL_11) ||       \
     ((CHANNEL) == ADC2_CHANNEL_12) || ((CHANNEL) == ADC2_CHANNEL_13) ||       \
     ((CHANNEL) == ADC2_CHANNEL_14) || ((CHANNEL) == ADC2_CHANNEL_15))
...
void ADC2_SchmittTriggerConfig(
  ADC2_SchmittTrigg_TypeDef ADC2_SchmittTriggerChannel,
