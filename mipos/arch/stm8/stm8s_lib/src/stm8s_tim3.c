...
/**
 * @brief  Deinitializes the TIM3 peripheral registers to their default reset
 * values.
 * @param  None
 * @retval None
 */
 ...
 * @param   TIM3_OCMode specifies the Output Compare mode  from @ref
 * TIM3_OCMode_TypeDef.
 * @param   TIM3_OutputState specifies the Output State  from @ref
 * TIM3_OutputState_TypeDef.
 * @param   TIM3_Pulse specifies the Pulse width  value.
 * @param   TIM3_OCPolarity specifies the Output Compare Polarity  from @ref
                  ...
                  TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
{
    ...
    TIM3->CCER1 |= (uint8_t)((uint8_t)(TIM3_OutputState & TIM3_CCER1_CC1E) |
                             (uint8_t)(TIM3_OCPolarity & TIM3_CCER1_CC1P));
                  ...
                  TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
{
    ...
    /* Set the Output State & Set the Output Polarity */
    TIM3->CCER1 |= (uint8_t)((uint8_t)(TIM3_OutputState & TIM3_CCER1_CC2E) |
                             (uint8_t)(TIM3_OCPolarity & TIM3_CCER1_CC2P));
...
/**
 * @brief  Initializes the TIM3 peripheral according to the specified
 * parameters.
 * @param    TIM3_Channel specifies the Input Capture Channel from @ref
 * TIM3_Channel_TypeDef.
 * @param   TIM3_ICPolarity specifies the Input Capture Polarity from @ref
 * TIM3_ICPolarity_TypeDef.
 * @param   TIM3_ICSelection specifies the Input Capture Selection from @ref
 * TIM3_ICSelection_TypeDef.
 * @param   TIM3_ICPrescaler specifies the Input Capture Prescaler from @ref
 * TIM3_ICPSC_TypeDef.
 * @param   TIM3_ICFilter specifies the Input Capture Filter value (value can be
 ...
 * @param   TIM3_IT specifies the TIM3 interrupts sources to be enabled or
 ...
 * @param   NewState new state of the TIM3 peripheral Preload register. This
 ...
 * @param   TIM3_ForcedAction specifies the forced Action to be set to the
 * output waveform. This parameter can be one of the following values:
 *                       - TIM3_FORCEDACTION_ACTIVE: Force active level on
 * OC1REF
 ...
 *                       - TIM3_EVENTSOURCE_CC1: TIM3 Capture Compare 1 Event
 * source
 *                       - TIM3_EVENTSOURCE_CC2: TIM3 Capture Compare 2 Event
 * source
 * @retval None
 */
                     ...
                     TIM3_OCMode_TypeDef TIM3_OCMode)
{
    ...
    if (TIM3_Channel == TIM3_CHANNEL_1) {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM3->CCMR1 =
          (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM)) |
                    (uint8_t)TIM3_OCMode);
    } else {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM3->CCMR2 =
          (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) |
                    (uint8_t)TIM3_OCMode);
    }
}
...
void TIM3_SetIC1Prescaler(TIM3_ICPSC_TypeDef TIM3_IC1Prescaler)
{
    ...
    TIM3->CCMR1 =
      (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_ICxPSC)) |
...
void TIM3_SetIC2Prescaler(TIM3_ICPSC_TypeDef TIM3_IC2Prescaler)
{
    ...
    /* Reset the IC1PSC Bits & Set the IC1PSC value */
    TIM3->CCMR2 =
      (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_ICxPSC)) |
 ...
 *                       - TIM3_FLAG_CC1OF: TIM3 Capture Compare 1 over capture
 * Flag
 *                       - TIM3_FLAG_CC2OF: TIM3 Capture Compare 2 over capture
 * Flag
...
FlagStatus TIM3_GetFlagStatus(TIM3_FLAG_TypeDef TIM3_FLAG)
{
    ...
    if (((tim3_flag_l) | (uint8_t)(TIM3->SR2 & tim3_flag_h)) !=
        (uint8_t)RESET) {
        bitstatus = SET;
    } else {
        bitstatus = RESET;
...
ITStatus TIM3_GetITStatus(TIM3_IT_TypeDef TIM3_IT)
{
    ...
    if ((TIM3_itStatus != (uint8_t)RESET) &&
        (TIM3_itEnable != (uint8_t)RESET)) {
        bitstatus = SET;
    } else {
        bitstatus = RESET;
    }
 ...
 * This parameter can be one of the following values:
 *                       - TIM3_ICSELECTION_DIRECTTI: TIM3 Input 1 is selected
 * to be connected to IC1.
 *                       - TIM3_ICSELECTION_INDIRECTTI: TIM3 Input 1 is selected
                       ...
                       uint8_t TIM3_ICFilter)
{
    ...
    TIM3->CCMR1 =
      (uint8_t)((uint8_t)(TIM3->CCMR1 &
                          (uint8_t)(~(TIM3_CCMR_CCxS | TIM3_CCMR_ICxF))) |
                (uint8_t)(((TIM3_ICSelection)) |
 ...
 * @param   TIM3_ICSelection specifies the input to be used.
 * This parameter can be one of the following values:
 *                       - TIM3_ICSELECTION_DIRECTTI: TIM3 Input 2 is selected
 * to be connected to IC2.
 *                       - TIM3_ICSELECTION_INDIRECTTI: TIM3 Input 2 is selected
 * to be connected to IC1.
 * @param   TIM3_ICFilter Specifies the Input Capture Filter.
 * This parameter must be a value between 0x00 and 0x0F.
 * @retval None
