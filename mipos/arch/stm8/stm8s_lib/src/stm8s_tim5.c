...
/**
 * @brief  Deinitializes the TIM5 peripheral registers to their default reset
 * values.
 * @param  None
 * @retval None
 */
...
/**
 * @brief  Initializes the TIM5 Time Base Unit according to the specified
 * parameters.
 ...
 * @param   TIM5_OCMode specifies the Output Compare mode  from @ref
 * TIM5_OCMode_TypeDef.
 * @param   TIM5_OutputState specifies the Output State  from @ref
 * TIM5_OutputState_TypeDef.
 * @param   TIM5_Pulse specifies the Pulse width  value.
 * @param   TIM5_OCPolarity specifies the Output Compare Polarity  from @ref
...
/**
 * @brief  Initializes the TIM5 peripheral according to the specified
 * parameters.
 * @param    TIM5_Channel specifies the Input Capture Channel from @ref
 * TIM5_Channel_TypeDef.
 * @param   TIM5_ICPolarity specifies the Input Capture Polarity from @ref
 * TIM5_ICPolarity_TypeDef.
 * @param   TIM5_ICSelection specifies theInput Capture Selection from @ref
 * TIM5_ICSelection_TypeDef.
 * @param   TIM5_ICPrescaler specifies the Input Capture Prescaler from @ref
 * TIM5_ICPSC_TypeDef.
 * @param   TIM5_ICFilter specifies the Input Capture Filter value (value can be
                     ...
                     uint8_t TIM5_ICFilter)
{
    ...
    if (TIM5_Channel == TIM5_CHANNEL_1) {
        ...
        /* TI2 Configuration */
        TI2_Config(
          (uint8_t)icpolarity, (uint8_t)icselection, (uint8_t)TIM5_ICFilter);
 ...
 * @param   TIM5_IT specifies the TIM5 interrupts sources to be enabled or
 ...
 * @param   NewState new state of the TIM5 peripheral Preload register.This
 ...
 * @param   TIM5_ForcedAction specifies the forced Action to be set to the
 * output waveform. This parameter can be one of the following values:
 *                       - TIM5_FORCEDACTION_ACTIVE: Force active level on
 * OC1REF
 ...
 *                       - TIM5_EVENTSOURCE_CC1: TIM5 Capture Compare 1 Event
 * source
 *                       - TIM5_EVENTSOURCE_CC2: TIM5 Capture Compare 2 Event
 * source
 *                       - TIM5_EVENTSOURCE_CC3: TIM5 Capture Compare 3 Event
 * source
 * @retval None
 */
                     ...
                     TIM5_OCMode_TypeDef TIM5_OCMode)
{
    ...
    if (TIM5_Channel == TIM5_CHANNEL_1) {
        ...
        /* Reset the Output Compare Bits  Set the Output Compare Mode */
        TIM5->CCMR1 =
          (uint8_t)((uint8_t)(TIM5->CCMR1 & (uint8_t)(~TIM5_CCMR_OCM)) |
                    (uint8_t)TIM5_OCMode);
    } else if (TIM5_Channel == TIM5_CHANNEL_2) {
        ...
        /* Reset the Output Compare Bits ** Set the Output Compare Mode */
        TIM5->CCMR2 =
          (uint8_t)((uint8_t)(TIM5->CCMR2 & (uint8_t)(~TIM5_CCMR_OCM)) |
                    (uint8_t)TIM5_OCMode);
    } else {
        ...
        /* Reset the Output Compare Bits ** Set the Output Compare Mode */
        TIM5->CCMR3 =
          (uint8_t)((uint8_t)(TIM5->CCMR3 & (uint8_t)(~TIM5_CCMR_OCM)) |
                    (uint8_t)TIM5_OCMode);
    }
}
...
void TIM5_SetIC1Prescaler(TIM5_ICPSC_TypeDef TIM5_IC1Prescaler)
{
    ...
    TIM5->CCMR1 =
      (uint8_t)((uint8_t)(TIM5->CCMR1 & (uint8_t)(~TIM5_CCMR_ICxPSC)) |
...
void TIM5_SetIC2Prescaler(TIM5_ICPSC_TypeDef TIM5_IC2Prescaler)
{
    ...
    /* Reset the IC1PSC Bits */ /* Set the IC1PSC value */
    TIM5->CCMR2 =
      (uint8_t)((uint8_t)(TIM5->CCMR2 & (uint8_t)(~TIM5_CCMR_ICxPSC)) |
...
void TIM5_SetIC3Prescaler(TIM5_ICPSC_TypeDef TIM5_IC3Prescaler)
{
    ...
    /* Reset the IC1PSC Bits */ /* Set the IC1PSC value */
    TIM5->CCMR3 =
      (uint8_t)((uint8_t)(TIM5->CCMR3 & (uint8_t)(~TIM5_CCMR_ICxPSC)) |
 ...
 *                       - TIM5_FLAG_CC1OF: TIM5 Capture Compare 1 overcapture
 * Flag
 *                       - TIM5_FLAG_CC2OF: TIM5 Capture Compare 2 overcapture
 * Flag
 *                       - TIM5_FLAG_CC3OF: TIM5 Capture Compare 3 overcapture
 * Flag
...
ITStatus TIM5_GetITStatus(TIM5_IT_TypeDef TIM5_IT)
{
    ...
    if ((TIM5_itStatus != (uint8_t)RESET) &&
        (TIM5_itEnable != (uint8_t)RESET)) {
        bitstatus = SET;
    } else {
        bitstatus = RESET;
    }
 ...
 * This parameter can be one of the following values:
 *                       - TIM5_ICSELECTION_DIRECTTI: TIM5 Input 1 is selected
 * to be connected to IC1.
 *                       - TIM5_ICSELECTION_INDIRECTTI: TIM5 Input 1 is selected
                       ...
                       uint8_t TIM5_ICFilter)
{
    ...
    TIM5->CCMR1 =
      (uint8_t)((uint8_t)(TIM5->CCMR1 &
                          (uint8_t)(~(TIM5_CCMR_CCxS | TIM5_CCMR_ICxF))) |
                (uint8_t)(((TIM5_ICSelection)) |
                          ((uint8_t)(TIM5_ICFilter << 4))));
 ...
 * @param   TIM5_ICSelection specifies the input to be used.
 * This parameter can be one of the following values:
 *                       - TIM5_ICSELECTION_DIRECTTI: TIM5 Input 2 is selected
 * to be connected to IC2.
 *                       - TIM5_ICSELECTION_INDIRECTTI: TIM5 Input 2 is selected
 * to be connected to IC1.
 * @param   TIM5_ICFilter Specifies the Input Capture Filter.
 * This parameter must be a value between 0x00 and 0x0F.
 * @retval None
 ...
 * @param   TIM5_ICSelection specifies the input to be used.
 * This parameter can be one of the following values:
 *                       - TIM5_ICSELECTION_DIRECTTI: TIM5 Input 3 is selected
