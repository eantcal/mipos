               ...
               FunctionalState ADC2_SchmittTriggerState)
{
    ...
    respectively according to ADC2_ConversionMode & ADC2_Channel values  &
    ADC2_Align values */
  ...
  */
    ADC2_SchmittTriggerConfig(ADC2_SchmittTriggerChannel,
  ...
  FunctionalState NewState)
{
    ...
    if (ADC2_SchmittTriggerChannel == ADC2_SCHMITTTRIG_ALL) {
        ...
        if (NewState != DISABLE) {
            ADC2->TDRL &= (uint8_t)(~(
              uint8_t)((uint8_t)0x01 << (uint8_t)ADC2_SchmittTriggerChannel));
        } else /* NewState == DISABLE */
        {
            ADC2->TDRL |=
              (uint8_t)((uint8_t)0x01 << (uint8_t)ADC2_SchmittTriggerChannel);
        ...
        if (NewState != DISABLE) {
            ADC2->TDRH &= (uint8_t)(~(
              uint8_t)((uint8_t)0x01
                       << ((uint8_t)ADC2_SchmittTriggerChannel - (uint8_t)8)));
        } else /* NewState == DISABLE */
        {
            ADC2->TDRH |=
              (uint8_t)((uint8_t)0x01
