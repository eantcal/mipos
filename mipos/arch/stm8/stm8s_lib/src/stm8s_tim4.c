...
/**
 * @brief  Deinitializes the TIM4 peripheral registers to their default reset
 * values.
 * @param  None
 * @retval None
 */
 ...
 * @param   TIM4_IT specifies the TIM4 interrupts sources to be enabled or
 ...
 * @param   NewState new state of the TIM4 peripheral Preload register. This
