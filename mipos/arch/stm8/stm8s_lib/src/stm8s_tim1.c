...
/**
 * @brief  Deinitializes the TIM1 peripheral registers to their default reset
 * values.
 * @param  None
 * @retval None
 */
void TIM1_DeInit(void)
{
    ...
    /* Configure channels as inputs: it is necessary if lock level is equal to 2
     * or 3 */
    TIM1->CCMR1 = 0x01;
    TIM1->CCMR2 = 0x01;
    TIM1->CCMR3 = 0x01;
    TIM1->CCMR4 = 0x01;
    /* Then reset channel registers: it also works if lock level is equal to 2
     * or 3 */
    TIM1->CCER1 = TIM1_CCER1_RESET_VALUE;
    TIM1->CCER2 = TIM1_CCER2_RESET_VALUE;
 ...
 * @param  TIM1_CounterMode specifies the counter mode  from @ref
                       ...
                       uint8_t TIM1_RepetitionCounter)
{
    ...
    TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 &
                                    (uint8_t)(~(TIM1_CR1_CMS | TIM1_CR1_DIR))) |
                  ...
                  TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
{
    ...
    TIM1->CCER1 |=
      (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC1E) |
                  ...
                  TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
{
    ...
    Set the Output N Polarity */
    TIM1->CCER1 |=
      (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC2E) |
                  ...
                  TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
{
    ...
    Set the Output N Polarity */
    TIM1->CCER2 |=
      (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC3E) |
 ...
 * @param  TIM1_OSSIState specifies the OSSIS State from @ref
 * TIM1_OSSIState_TypeDef.
 * @param  TIM1_LockLevel specifies the lock level from @ref
                     ...
                     TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
{
    ...
    /* Set the Lock level, the Break enable Bit and the Polarity, the OSSI
    State, the dead time value  and the Automatic Output Enable Bit */

    TIM1->BKR =
      (uint8_t)((uint8_t)(TIM1_OSSIState | (uint8_t)TIM1_LockLevel) |
                (uint8_t)((uint8_t)(TIM1_Break | (uint8_t)TIM1_BreakPolarity) |
                          (uint8_t)TIM1_AutomaticOutput));
}

/**
 * @brief  Initializes the TIM1 peripheral according to the specified
 * parameters.
 ...
 * @param  NewState new state of the TIM1 peripheral.
 *         This parameter can be: ENABLE or DISABLE.
 * @param  TIM1_IT specifies the TIM1 interrupts sources to be enabled or
                              ...
                              uint8_t ExtTRGFilter)
{
    ...
    TIM1->SMCR =
      (uint8_t)((uint8_t)(TIM1->SMCR &
                          (uint8_t)(~(uint8_t)(TIM1_SMCR_SMS | TIM1_SMCR_TS))) |
                    ...
                    uint8_t ExtTRGFilter)
{
    ...
    TIM1->ETR |=
      (uint8_t)((uint8_t)(TIM1_ExtTRGPrescaler | (uint8_t)TIM1_ExtTRGPolarity) |
                (uint8_t)ExtTRGFilter);
}
 ...
 * @param   NewState new state of the TIM1 peripheral Preload register. This
 ...
 * @param   NewState new state of the TIM1 Hall sensor interface.This parameter
 ...
 * @param   NewState new state of the synchronization between TIM1 and its
 * slaves (through TRGO). This parameter can be ENABLE or DISABLE.
 * @retval None
 */
                                 ...
                                 TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
{
    ...
    TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR &
                                     (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS)) |
                           (uint8_t)TIM1_EncoderMode);

    /* Select the Capture Compare 1 and the Capture Compare 2 as input */
    TIM1->CCMR1 =
      (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS)) |
                (uint8_t)CCMR_TIxDirect_Set);
    TIM1->CCMR2 =
      (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS)) |
                (uint8_t)CCMR_TIxDirect_Set);
}
...
void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
{
    ...
    TIM1->CR1 =
      (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) &
                                                (uint8_t)(~TIM1_CR1_DIR))) |
                (uint8_t)TIM1_CounterMode);
}

/**
 * @brief  Forces the TIM1 Channel1 output waveform to active or inactive level.
 * @param   TIM1_ForcedAction specifies the forced Action to be set to the
 * output waveform. This parameter can be one of the following values:
 ...
 * @param   TIM1_ForcedAction specifies the forced Action to be set to the
 * output waveform. This parameter can be one of the following values:
 *                       - TIM1_FORCEDACTION_ACTIVE: Force active level on
 * OC3REF
...
/**
 * @brief  Sets or Resets the TIM1 peripheral Capture Compare Preload Control
 * bit.
 ...
 *                       - TIM1_EVENTSOURCE_CC1: TIM1 Capture Compare 1 Event
 * source
 *                       - TIM1_EVENTSOURCE_CC2: TIM1 Capture Compare 2 Event
 * source
 *                       - TIM1_EVENTSOURCE_CC3: TIM1 Capture Compare 3 Event
 * source
 *                       - TIM1_EVENTSOURCE_CC4: TIM1 Capture Compare 4 Event
 * source
                     ...
                     TIM1_OCMode_TypeDef TIM1_OCMode)
{
    ...
    if (TIM1_Channel == TIM1_CHANNEL_1) {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM1->CCMR1 =
          (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) |
                    (uint8_t)TIM1_OCMode);
    } else if (TIM1_Channel == TIM1_CHANNEL_2) {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM1->CCMR2 =
          (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) |
                    (uint8_t)TIM1_OCMode);
    } else if (TIM1_Channel == TIM1_CHANNEL_3) {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM1->CCMR3 =
          (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) |
                    (uint8_t)TIM1_OCMode);
    } else {
        /* Disable the Channel 4: Reset the CCE Bit */
        TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM1->CCMR4 =
          (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) |
                    (uint8_t)TIM1_OCMode);
    }
}
...
void TIM1_SetIC1Prescaler(TIM1_ICPSC_TypeDef TIM1_IC1Prescaler)
{
    ...
    TIM1->CCMR1 =
      (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
...
void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
{
    ...
    /* Reset the IC1PSC Bits */ /* Set the IC1PSC value */
    TIM1->CCMR2 =
      (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
...
void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
{
    ...
    /* Reset the IC1PSC Bits & Set the IC1PSC value */
    TIM1->CCMR3 =
      (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
...
void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
{
    ...
    /* Reset the IC1PSC Bits &  Set the IC1PSC value */
    TIM1->CCMR4 =
      (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
 ...
 *                       - TIM1_FLAG_TRIGGER: TIM1 Trigger Flag
 *                       - TIM1_FLAG_BREAK: TIM1 Break Flag
 *                       - TIM1_FLAG_CC1OF: TIM1 Capture Compare 1 overcapture
 * Flag
 *                       - TIM1_FLAG_CC2OF: TIM1 Capture Compare 2 overcapture
 * Flag
 *                       - TIM1_FLAG_CC3OF: TIM1 Capture Compare 3 overcapture
 * Flag
 *                       - TIM1_FLAG_CC4OF: TIM1 Capture Compare 4 overcapture
 * Flag
 * @retval None.
 */
void TIM1_ClearFlag(TIM1_FLAG_TypeDef TIM1_FLAG)
{
    ...
    /* Clear the flags (rc_w0) clear this bit by writing 0. Writing ‘1’ has no
     * effect*/
...
ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
{
    ...
    if ((TIM1_itStatus != (uint8_t)RESET) &&
        (TIM1_itEnable != (uint8_t)RESET)) {
        bitstatus = SET;
    } else {
        bitstatus = RESET;
    }
 ...
 *         This parameter can be one of the following values:
 *                       - TIM1_ICSELECTION_DIRECTTI: TIM1 Input 1 is selected
 * to be connected to IC1.
 *                       - TIM1_ICSELECTION_INDIRECTTI: TIM1 Input 1 is selected
                       ...
                       uint8_t TIM1_ICFilter)
{
    ...
    TIM1->CCMR1 =
      (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~(uint8_t)(TIM1_CCMR_CCxS |
                                                             TIM1_CCMR_ICxF))) |
                (uint8_t)(((TIM1_ICSelection)) |
                          ((uint8_t)(TIM1_ICFilter << 4))));
 ...
 * @param  TIM1_ICSelection specifies the input to be used.
 *         This parameter can be one of the following values:
 *                       - TIM1_ICSELECTION_DIRECTTI: TIM1 Input 2 is selected
 * to be connected to IC2.
 *                       - TIM1_ICSELECTION_INDIRECTTI: TIM1 Input 2 is selected
 * to be connected to IC1.
 * @param  TIM1_ICFilter Specifies the Input Capture Filter.
 *         This parameter must be a value between 0x00 and 0x0F.
 * @retval None
                       ...
                       uint8_t TIM1_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    TIM1->CCMR2 =
      (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~(uint8_t)(TIM1_CCMR_CCxS |
                                                             TIM1_CCMR_ICxF))) |
                (uint8_t)(((TIM1_ICSelection)) |
                          ((uint8_t)(TIM1_ICFilter << 4))));
    /* Select the Polarity */
 ...
 * @param  TIM1_ICSelection specifies the input to be used.
 *         This parameter can be one of the following values:
 *                       - TIM1_ICSELECTION_DIRECTTI: TIM1 Input 3 is selected
 * to be connected to IC3.
 *                       - TIM1_ICSELECTION_INDIRECTTI: TIM1 Input 3 is selected
                       ...
                       uint8_t TIM1_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    TIM1->CCMR3 =
      (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~(uint8_t)(TIM1_CCMR_CCxS |
                                                             TIM1_CCMR_ICxF))) |
                (uint8_t)(((TIM1_ICSelection)) |
                          ((uint8_t)(TIM1_ICFilter << 4))));
 ...
 * @param  TIM1_ICSelection specifies the input to be used.
 *         This parameter can be one of the following values:
 *                       - TIM1_ICSELECTION_DIRECTTI: TIM1 Input 4 is selected
 * to be connected to IC4.
 *                       - TIM1_ICSELECTION_INDIRECTTI: TIM1 Input 4 is selected
 * to be connected to IC3.
 * @param  TIM1_ICFilter Specifies the Input Capture Filter.
 *         This parameter must be a value between 0x00 and 0x0F.
 * @retval None
                       ...
                       uint8_t TIM1_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    TIM1->CCMR4 =
      (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~(uint8_t)(TIM1_CCMR_CCxS |
                                                             TIM1_CCMR_ICxF))) |
                (uint8_t)(((TIM1_ICSelection)) |
                          ((uint8_t)(TIM1_ICFilter << 4))));
