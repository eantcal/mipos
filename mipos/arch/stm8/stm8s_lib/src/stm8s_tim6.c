...
/**
 * @brief  Deinitializes the TIM6 peripheral registers to their default reset
 * values.
 * @param  None
 * @retval None
 */
 ...
 * parameters.
 * @param   TIM6_Prescaler : This parameter can be any of the @Ref
 * TIM5_Prescaler_TypeDef enumeration.
 ...
 * @param   TIM6_IT : Specifies the TIM6 interrupts sources to be enabled or
 * disabled. This parameter can be any combination of the @ref TIM6_IT_TypeDef
 * enumeration.
 * @param   NewState : The new state of the TIM6 peripheral.
 * This parameter can be any of the @ref FunctionalState enumeration.
 * @retval None
 * @par Required preconditions:
 * If QST option bit is enabled, the TIM6 Interrupt vector will be mapped on IRQ
 * number 2 (irq0). Otherwise, it will be mapped on IRQ number 27 (irq25).
 */
 ...
 * @param   NewState : The new state of the synchronization between TIM6 and its
 * slaves (through TRGO). This parameter can be any of the @ref FunctionalState
 * enumeration.
 * @retval None
 */
