...
static void TI2_Config(uint8_t TIM2_ICPolarity,
                       uint8_t TIM2_ICSelection,
                       uint8_t TIM2_ICFilter);
static void TI3_Config(uint8_t TIM2_ICPolarity,
                       uint8_t TIM2_ICSelection,
                       uint8_t TIM2_ICFilter);
/**
...
/**
 * @brief  Deinitializes the TIM2 peripheral registers to their default reset
 * values.
 * @param  None
 * @retval None
 */
 ...
 * @param   TIM2_OCMode specifies the Output Compare mode  from @ref
 * TIM2_OCMode_TypeDef.
 * @param   TIM2_OutputState specifies the Output State  from @ref
 * TIM2_OutputState_TypeDef.
 * @param   TIM2_Pulse specifies the Pulse width  value.
 * @param   TIM2_OCPolarity specifies the Output Compare Polarity  from @ref
                  ...
                  TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
{
    ...
    /* Disable the Channel 1: Reset the CCE Bit, Set the Output State , the
     * Output Polarity */
...
/**
 * @brief  Initializes the TIM2 peripheral according to the specified
 * parameters.
 * @param    TIM2_Channel specifies the Input Capture Channel from @ref
 * TIM2_Channel_TypeDef.
 * @param   TIM2_ICPolarity specifies the Input Capture Polarity from @ref
 * TIM2_ICPolarity_TypeDef.
 * @param   TIM2_ICSelection specifies the Input Capture Selection from @ref
 * TIM2_ICSelection_TypeDef.
 * @param   TIM2_ICPrescaler specifies the Input Capture Prescaler from @ref
 * TIM2_ICPSC_TypeDef.
 * @param   TIM2_ICFilter specifies the Input Capture Filter value (value can be
 * an integer from 0x00 to 0x0F).
 * @retval None
 */
 ...
 * @param   TIM2_IT specifies the TIM2 interrupts sources to be enabled or
 ...
 * @param   NewState new state of the TIM2 peripheral Preload register. This
 ...
 * @param   TIM2_ForcedAction specifies the forced Action to be set to the
 * output waveform. This parameter can be one of the following values:
 *                       - TIM2_FORCEDACTION_ACTIVE: Force active level on
 * OC1REF
 ...
 *                       - TIM2_EVENTSOURCE_CC1: TIM2 Capture Compare 1 Event
 * source
 *                       - TIM2_EVENTSOURCE_CC2: TIM2 Capture Compare 2 Event
 * source
 *                       - TIM2_EVENTSOURCE_CC3: TIM2 Capture Compare 3 Event
 * source
 * @retval None
 */
                     ...
                     TIM2_OCMode_TypeDef TIM2_OCMode)
{
    ...
    if (TIM2_Channel == TIM2_CHANNEL_1) {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM2->CCMR1 =
          (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM)) |
                    (uint8_t)TIM2_OCMode);
    } else if (TIM2_Channel == TIM2_CHANNEL_2) {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM2->CCMR2 =
          (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM)) |
                    (uint8_t)TIM2_OCMode);
    } else {
        ...
        /* Reset the Output Compare Bits & Set the Output Compare Mode */
        TIM2->CCMR3 =
          (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM)) |
                    (uint8_t)TIM2_OCMode);
    }
}
...
void TIM2_SetIC1Prescaler(TIM2_ICPSC_TypeDef TIM2_IC1Prescaler)
{
    ...
    TIM2->CCMR1 =
      (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_ICxPSC)) |
...
void TIM2_SetIC2Prescaler(TIM2_ICPSC_TypeDef TIM2_IC2Prescaler)
{
    ...
    /* Reset the IC1PSC Bits &Set the IC1PSC value */
    TIM2->CCMR2 =
      (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_ICxPSC)) |
...
void TIM2_SetIC3Prescaler(TIM2_ICPSC_TypeDef TIM2_IC3Prescaler)
{
    ...
    /* Reset the IC1PSC Bits &Set the IC1PSC value */
    TIM2->CCMR3 =
      (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_ICxPSC)) |
 ...
 *                       - TIM2_FLAG_CC1OF: TIM2 Capture Compare 1 over capture
 * Flag
 *                       - TIM2_FLAG_CC2OF: TIM2 Capture Compare 2 over capture
 * Flag
 *                       - TIM2_FLAG_CC3OF: TIM2 Capture Compare 3 over capture
 * Flag
...
void TIM2_ClearFlag(TIM2_FLAG_TypeDef TIM2_FLAG)
{
    ...
    TIM2->SR2 =
      (uint8_t)(~((uint8_t)(TIM2_FLAG >> 8))); // [Roshan, 2015-Nov-09]
}
...
ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
{
    ...
    if ((TIM2_itStatus != (uint8_t)RESET) &&
        (TIM2_itEnable != (uint8_t)RESET)) {
        bitstatus = SET;
    } else {
        bitstatus = RESET;
    }
 ...
 * This parameter can be one of the following values:
 *                       - TIM2_ICSELECTION_DIRECTTI: TIM2 Input 1 is selected
 * to be connected to IC1.
 *                       - TIM2_ICSELECTION_INDIRECTTI: TIM2 Input 1 is selected
                       ...
                       uint8_t TIM2_ICFilter)
{
    ...
    TIM2->CCMR1 =
      (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~(uint8_t)(TIM2_CCMR_CCxS |
                                                             TIM2_CCMR_ICxF))) |
                (uint8_t)(((TIM2_ICSelection)) |
                          ((uint8_t)(TIM2_ICFilter << 4))));
 ...
 * @param   TIM2_ICSelection specifies the input to be used.
 * This parameter can be one of the following values:
 *                       - TIM2_ICSELECTION_DIRECTTI: TIM2 Input 2 is selected
 * to be connected to IC2.
 *                       - TIM2_ICSELECTION_INDIRECTTI: TIM2 Input 2 is selected
 * to be connected to IC1.
 * @param   TIM2_ICFilter Specifies the Input Capture Filter.
 * This parameter must be a value between 0x00 and 0x0F.
 * @retval None
                       ...
                       uint8_t TIM2_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    TIM2->CCMR2 =
      (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~(uint8_t)(TIM2_CCMR_CCxS |
                                                             TIM2_CCMR_ICxF))) |
                (uint8_t)(((TIM2_ICSelection)) |
                          ((uint8_t)(TIM2_ICFilter << 4))));
 ...
 * @param   TIM2_ICSelection specifies the input to be used.
 * This parameter can be one of the following values:
 *                       - TIM2_ICSELECTION_DIRECTTI: TIM2 Input 3 is selected
                       ...
                       uint8_t TIM2_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    TIM2->CCMR3 =
      (uint8_t)((uint8_t)(TIM2->CCMR3 &
                          (uint8_t)(~(TIM2_CCMR_CCxS | TIM2_CCMR_ICxF))) |
                (uint8_t)(((TIM2_ICSelection)) |
                          ((uint8_t)(TIM2_ICFilter << 4))));
